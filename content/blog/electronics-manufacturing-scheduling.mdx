...
A common mistake is scheduling SMT lines at maximum throughput without considering whether the test floor can absorb the output. [Finite capacity scheduling](/blogs/finite-capacity-planning-guide) prevents this by scheduling all operations — from placement through final test — against their actual capacity.
