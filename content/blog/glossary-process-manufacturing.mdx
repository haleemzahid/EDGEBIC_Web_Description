...
- [Continuous Production](/blogs/glossary-continuous-production) — A subset of process manufacturing where material flows without interruption
- [Discrete Manufacturing](/blogs/glossary-discrete-manufacturing) — The contrasting production method that assembles countable units from components
- [Changeover](/blogs/glossary-changeover) — The cleaning and reconfiguration between batches in process manufacturing
