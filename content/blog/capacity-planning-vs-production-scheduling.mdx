...
<Image
  src="/marketing/blog/capacity-planning-vs-production-scheduling/hero.webp"
  alt="Manufacturing dashboard showing capacity planning overview alongside a detailed production schedule Gantt chart"
  width="768"
  height="432"
...
This guide clarifies the differences, explains how the two disciplines interact, and shows how the right tools make both more effective. At [User Solutions](https://usersolutions.com), we help manufacturers bridge the gap between planning and scheduling every day through our [production scheduling software](/blogs/production-scheduling-software-guide).
...
**Rough-Cut Capacity Planning (RCCP):** A high-level check that validates the [Master Production Schedule](/blogs/master-production-schedule-guide) against available capacity at critical work centers. RCCP answers: "Is this MPS feasible at our bottleneck resources?"
...
- Job sequencing using [priority dispatch rules](/blogs/production-scheduling-methods)
- [Finite capacity loading](/blogs/finite-vs-infinite-capacity-scheduling) that prevents resource double-booking
- [Multi-constraint scheduling](/blogs/multi-constraint-scheduling) across machines, labor, tooling, and materials
- [Setup optimization](/blogs/production-schedule-optimization) to minimize changeover time
- Rescheduling in response to disruptions
- [What-if analysis](/blogs/what-if-analysis-production-scheduling) for decision support
...
- [KPI metrics](/blogs/production-scheduling-kpis) for schedule performance
...
This gap is invisible to aggregate planning tools. Only [finite capacity scheduling](/blogs/finite-vs-infinite-capacity-scheduling) at the machine level reveals these hidden [bottlenecks](/blogs/production-bottleneck-identification).
...
- Add overtime or shifts at [bottleneck resources](/blogs/production-bottleneck-identification)
...
- Implement [finite capacity scheduling](/blogs/finite-vs-infinite-capacity-scheduling)
- Apply [scheduling optimization techniques](/blogs/production-schedule-optimization)
- Use [what-if analysis](/blogs/what-if-analysis-production-scheduling) for decision support
- Track [scheduling KPIs](/blogs/production-scheduling-kpis) and continuously improve
