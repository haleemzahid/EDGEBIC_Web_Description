...
1. **Week one:** the floor starts punching or the lead starts filling the grid. The first plan-versus-actual overlay appears, and it is usually uncomfortable, because it shows the drift the old process hid. The operations sitting behind plan are [a finite investigation list rather than an adherence percentage](/blog/how-an-adherence-number-becomes-an-investigation-list).
