...
Wheels crack, warp, or fail speed test, and they fail after you have already paid for the mix, the press, and the cure. Model expected yield on the routing so the quantity started covers the loss, rather than discovering at the test stand that you are short. That also means downstream finishing capacity is reserved for the quantity that will actually arrive. The mechanics are in [how a schedule accounts for scrap and yield loss](/blog/how-a-schedule-accounts-for-scrap-and-yield-loss).
