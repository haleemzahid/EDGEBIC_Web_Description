...
For the broader quality management context, see our [quality control manufacturing guide](/blog/quality-control-manufacturing-guide).
...
[Control charts](/blog/control-charts-manufacturing) are the visual engine of SPC. A control chart plots measured values over time against statistically calculated control limits.
...
|---|---|---|
| [X-bar and R](/blog/x-bar-r-charts) | Subgroup average and range | Continuous data, small subgroups (n=2-10) |
...
| [p-chart](/blog/p-chart-quality-control) | Proportion defective | Attribute data, varying sample sizes |
...
Choosing the right chart depends on your data type (continuous vs attribute) and sampling method. See our detailed guides on [control charts](/blog/control-charts-manufacturing), [X-bar and R charts](/blog/x-bar-r-charts), and [p-charts](/blog/p-chart-quality-control) for specific applications.
...
- Processes subject to [ISO 9001](/blog/iso-9001-manufacturers) or customer-mandated SPC
...
- Document [root cause analysis](/blog/root-cause-analysis) for every special cause event
...
- If capability is insufficient, use [root cause analysis](/blog/root-cause-analysis) and [FMEA](/blog/fmea-manufacturing) to identify improvement opportunities
- Make process improvements, then recalculate capability to verify improvement
- Use the [CAPA process](/blog/capa-manufacturing) to formalize corrective actions
...
[Finite capacity scheduling](/blog/finite-capacity-planning-guide) with [RMDB](/resource-manager-db-2) addresses these issues:
...
SPC connected to [MES](/blog/mes-manufacturing-execution-system), [IoT sensors](/blog/iot-manufacturing), and scheduling creates a closed loop where process data drives both quality and scheduling decisions automatically.
