...
A related metric is [Days Inventory Outstanding (DIO)](/blogs/glossary-days-inventory-outstanding): DIO = 365 / Inventory Turnover. This converts the turnover ratio into the average number of days inventory is held before being sold. A turnover of 6 equals a DIO of approximately 61 days.
...
By implementing [vendor-managed inventory](/blogs/glossary-vendor-managed-inventory) for A-class raw materials and reducing order quantities to align with [EOQ](/blogs/glossary-economic-order-qty), the company reduces average raw material inventory to $900,000. New total inventory: $2,700,000. New turnover: 6.7 turns — a 12% improvement that frees $300,000 in working capital.
...
- [Days Inventory Outstanding](/blogs/glossary-days-inventory-outstanding) — the number of days of inventory on hand, derived from turnover
- [Carrying Cost](/blogs/glossary-carrying-cost) — the holding costs that decrease as turnover improves
- [WIP Inventory](/blogs/glossary-wip-inventory) — in-process inventory whose turnover reflects manufacturing efficiency
