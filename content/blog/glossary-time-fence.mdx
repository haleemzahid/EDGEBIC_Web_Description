...
- [Scheduling Horizon](/blogs/glossary-scheduling-horizon) — The overall time period that contains the time fences
- [Master Production Schedule](/blogs/glossary-master-production-schedule) — The production plan that time fences protect from unauthorized changes
- [What-If Analysis](/blogs/glossary-what-if-analysis) — The simulation capability used to evaluate the impact of changes within time fences before committing them
