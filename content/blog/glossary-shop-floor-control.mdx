...
- [Dispatch List](/blogs/glossary-dispatch-list) — The prioritized work list that SFC uses to direct operators at each work center
- [Gantt Chart](/blogs/glossary-gantt-chart) — The visual schedule display that SFC data keeps current and accurate
- [Utilization](/blogs/glossary-utilization) — A key SFC metric measuring how effectively resources are being used
