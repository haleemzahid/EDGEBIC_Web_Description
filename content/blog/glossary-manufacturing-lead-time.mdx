...
- [Lead Time](/blogs/glossary-lead-time) — The broader concept that includes procurement, manufacturing, and delivery lead times
- [Queue Time](/blogs/glossary-queue-time) — The dominant component of manufacturing lead time that scheduling aims to reduce
- [Setup Time](/blogs/glossary-setup-time) — The preparation time at each operation that directly adds to manufacturing lead time
