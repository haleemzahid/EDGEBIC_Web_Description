...
This post is about one outcome: total units out the door, not utilization percentage. It sits under the [EDGEBIC results guide](/blog/edgebic-results-guide) and is the throughput-focused companion to [how EDGEBIC raises bottleneck utilization](/blog/how-edgebic-raises-bottleneck-utilization), which covers the utilization metric in depth. For finding the constraint in the first place, see [production bottleneck identification](/blog/production-bottleneck-identification).
