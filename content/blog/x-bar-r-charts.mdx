...
<Image
  ...
  alt="X-bar and R control charts displayed on a quality monitoring screen in a manufacturing setting"
  width="768"
  height="432"
  className="w-full rounded-lg"
/>

The **X-bar and R chart** is the workhorse of manufacturing [SPC](/blogs/statistical-process-control-spc). If you measure a dimension, weight, pressure, temperature, or any other continuous characteristic on your parts, X-bar and R charts are likely the right tool for monitoring that process. They are the most widely used [control chart](/blogs/control-charts-manufacturing) type in manufacturing for good reason: they are straightforward to implement, intuitive to interpret, and powerful at detecting process changes.

For the broader quality context, see our [quality control manufacturing guide](/blogs/quality-control-manufacturing-guide).
...
- **Run above or below center line**: Process has shifted and stayed shifted. [Root cause analysis](/blogs/root-cause-analysis) needed.
...
- Correlate [scheduling stability](/blogs/what-is-production-scheduling) with process stability
