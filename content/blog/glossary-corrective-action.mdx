...
Corrective actions are triggered by various events including customer complaints, internal audit findings, [inspection](/blogs/glossary-inspection) failures, [control chart](/blogs/glossary-control-chart) out-of-control signals, returned products, and process deviations. An effective corrective action system ensures that each trigger receives a proportionate response based on the severity and frequency of the problem.
...
**Step 3: [Root Cause Analysis](/blogs/glossary-root-cause-analysis).** Investigate the fundamental cause of the problem using tools such as the 5 Whys, fishbone diagrams, [FMEA](/blogs/glossary-fmea), or fault tree analysis. The root cause is the deepest systemic reason the problem occurred — not the proximate trigger.
...
- [Root Cause Analysis](/blogs/glossary-root-cause-analysis) — the investigation methodology used within corrective action to find the fundamental cause
- [Preventive Action](/blogs/glossary-preventive-action) — the proactive counterpart to corrective action, addressing potential problems before they occur
- [DMAIC](/blogs/glossary-dmaic) — a structured improvement methodology that formalizes the corrective action process
