...
Queue and flow are competing answers to the same question, when can the next step begin. Transit is a separate concern, when does the material arrive, so it composes after whichever gate applies.
