...
- **Review and accept promptly.** The guard only fires when the base moves between generating and accepting, so a tight generate-then-decide loop avoids it. A proposal also lives only on your screen until you Accept, which is why [an optimizer proposal can disappear before you accept it](/blog/my-optimizer-proposal-disappeared-edgebic).
