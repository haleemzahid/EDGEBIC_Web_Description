...
<Image
  src="/marketing/blog/queue-time-scheduling-lever/hero.webp"
  alt="Industrial factory interior with conveyor system showing production flow and work-in-process"
  width="768"
  height="432"
