...
To see the full quote-to-order flow, read [EDGEBIC quote simulation explained](/blog/edgebic-quote-simulation-explained) and [EDGEBIC what-if scenarios explained](/blog/edgebic-what-if-scenarios-explained). To connect a promised date to available capacity, continue with [available to promise](/blog/what-is-available-to-promise).
