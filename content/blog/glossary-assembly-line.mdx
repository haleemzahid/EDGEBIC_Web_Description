...
- [Production Line](/blogs/glossary-production-line) — A broader term that includes assembly lines and other sequential production arrangements
- [Takt Time](/blogs/glossary-takt-time) — The pace at which the assembly line must produce to meet customer demand
- [Subassembly](/blogs/glossary-subassembly) — A partially completed component that feeds into the assembly line
