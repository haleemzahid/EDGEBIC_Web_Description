...
- [Assemble-to-Order](/blog/glossary/assemble-to-order) — The closely related strategy focused on physical module assembly
- [Engineer-to-Order](/blog/glossary/engineer-to-order) — The more customized strategy where each order requires new engineering, which CTO avoids
- [Make-to-Order](/blog/glossary/make-to-order) — A strategy where the full product is manufactured upon order, without the CTO platform approach
