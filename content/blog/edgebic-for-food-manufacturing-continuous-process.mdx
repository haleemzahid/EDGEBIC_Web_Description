...
Continuous stations, where the lag is right: extruders, ovens and dryers, cooling tunnels, pasteurisers and homogenisers, coating and enrobing lines, mixing and blending vessels, spray and cure lines. A kibble plant is mostly the first entry on that list, and [extrusion and changeover scheduling for pet food](/blog/edgebic-for-pet-food-production-scheduling) works through what modeling it as continuous does to a whole line.
...
Continuous equipment is one of three constraints food plants usually need. The others are covered in [allergen and flavor changeover sequencing](/blog/edgebic-for-food-manufacturing-changeover-sequencing) and [scheduling around shifts, sanitation and holidays](/blog/edgebic-for-food-manufacturing-shift-calendars). Plants that also run reactors or blending vessels will recognize the same problem in [chemical manufacturing scheduling](/blog/chemical-manufacturing-scheduling). Bakeries meet it at the oven, which holds a bake for its full cycle: see [bakery oven and line scheduling](/blog/edgebic-for-commercial-bakery-oven-scheduling).
