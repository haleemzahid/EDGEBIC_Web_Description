...
<Image
  ...
  alt="Quality control p-chart displayed on screen showing proportion defective data with control limits"
  width="768"
  height="432"
...
For the broader [SPC](/blogs/statistical-process-control-spc) context and other chart types, see our guides on [control charts](/blogs/control-charts-manufacturing) and the [quality control manufacturing guide](/blogs/quality-control-manufacturing-guide).
...
- [Incoming quality inspection](/blogs/incoming-quality-inspection) tracking
...
- Any non-random patterns per the [Western Electric rules](/blogs/control-charts-manufacturing)
...
2. Conduct [root cause analysis](/blogs/root-cause-analysis) on the defective items
3. Implement corrective action through the [CAPA process](/blogs/capa-manufacturing)
...
- Apply [FMEA](/blogs/fmea-manufacturing) to prioritize improvement efforts
- Investigate whether [scheduling issues](/blogs/what-is-production-scheduling) contribute to defects (rushed setups, overtime, expediting)
...
- [Properly scheduled production](/blogs/finite-capacity-planning-guide) with adequate setup time produces lower, more stable defective rates
