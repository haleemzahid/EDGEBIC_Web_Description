...
The calculation is forward-looking and anchored to physical on-hand now, not to a historical opening balance. It also has an outer edge, the [ATP horizon](/blog/what-is-an-atp-horizon-in-planning), past which there are no buckets and so no calculated promise. It produces two values per time bucket:
