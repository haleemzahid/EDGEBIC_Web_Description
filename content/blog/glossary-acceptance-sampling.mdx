...
- [Statistical Process Control (SPC)](/blogs/glossary-spc) — real-time process monitoring that complements acceptance sampling
- [Defect](/blogs/glossary-defect) — a nonconformance identified during acceptance sampling inspection
- [Inspection](/blogs/glossary-inspection) — the broader quality evaluation process that includes acceptance sampling
