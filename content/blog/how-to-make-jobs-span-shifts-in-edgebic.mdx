...
faqQuestions:
  ...
  - question: "What should work center utilization be set to?"
    answer: "Utilization is the percentage of nominal shift hours the scheduler is allowed to claim, and it sits at 100 percent with no editor field on the work center screen. So nothing scales the hours down for you, and the honest place to describe what a machine genuinely converts to production is the shift itself, after breaks, minor stoppages, and unrecorded interruptions. Many shops land between 80 and 90 percent of the clock for well-run equipment, which on an 8-hour window is a shift of roughly 6.5 to 7.2 hours."
