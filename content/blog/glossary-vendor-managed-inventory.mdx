...
- [Safety Stock](/blogs/glossary-safety-stock) — Buffer inventory that VMI aims to reduce while maintaining service levels
- [Lead Time](/blogs/glossary-lead-time) — The replenishment window that the supplier manages under VMI
- [Procurement](/blogs/glossary-procurement) — The broader purchasing function that VMI partially automates
