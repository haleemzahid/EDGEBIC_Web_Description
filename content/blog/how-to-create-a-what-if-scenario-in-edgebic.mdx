...
For the strategy behind comparing alternatives, read [what-if scenarios explained](/blog/edgebic-what-if-scenarios-explained). This task is documented behavior of [EDGEBIC](/edgebic), and the full task library is in the [how-to hub](/blog/edgebic-how-to-hub).
