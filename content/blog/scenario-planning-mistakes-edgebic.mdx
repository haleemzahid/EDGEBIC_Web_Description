...
**Fix.** Read all three before choosing. The utilization chart exists exactly for this decision, and a slightly slower scenario with room to recover is often the better commercial answer. [Production bottleneck identification](/blog/production-bottleneck-identification) covers how to think about the constrained machine.
...
| All three comparison charts read, not just lead time | Utilization shows whether the plan can absorb trouble |
