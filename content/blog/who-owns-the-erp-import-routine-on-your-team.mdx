...
The import routine is one slice of a larger question about who administers the scheduling system: the database, user roles, scheduling policy, and grid layouts each have their own natural owner. [Splitting EDGEBIC admin duties between IT and planning](/blog/who-owns-what-splitting-edgebic-admin-duties) covers the full map. Access to the export files is a separate question, because a nightly file holds customer names, prices, and labor rates: [who should see your ERP export files](/blog/who-should-see-your-erp-export-files) covers where the folder belongs. What is specific to the import routine is that it looks technical and is not. The mechanics are two clicks. The judgment is the job.
