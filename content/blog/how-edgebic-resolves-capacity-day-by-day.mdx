...
The day shift on a two-instance work center offers 14.5 hours that date instead of 16. The night shift loses nothing, because nobody on nights was in the meeting. That is the argument for modelling meetings as partial holidays rather than by shrinking shifts: one record, plant-wide, charged correctly to each shift, repeating automatically if the holiday recurs.
