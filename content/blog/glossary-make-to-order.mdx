...
- [Make-to-Stock](/blogs/glossary-make-to-stock) — The opposite strategy where products are manufactured to forecast and held in finished goods inventory
- [Engineer-to-Order](/blogs/glossary-engineer-to-order) — A strategy requiring custom engineering before production, with even longer lead times than MTO
- [Assemble-to-Order](/blogs/glossary-assemble-to-order) — A hybrid strategy that stocks subassemblies and assembles to order for shorter lead times
