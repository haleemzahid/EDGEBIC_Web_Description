...
If the overlap you see is meant to be lot streaming, the [transfer batch](/blog/what-is-a-transfer-batch) definition covers how to configure the intentional version so the check treats it correctly. For the full validation catalog, read [what the EDGEBIC anomaly checks actually look for](/blog/what-the-edgebic-anomaly-checks-actually-look-for) and the [schedule diagnostics overview](/blog/edgebic-schedule-diagnostics-explained).
