...
- [Make-to-Order](/blog/glossary-make-to-order) — The opposite strategy where production starts only after an order is received
- [Master Production Schedule](/blog/glossary-master-production-schedule) — The planning tool that drives MTS production quantities and timing
- [Safety Stock](/blog/glossary-safety-stock) — Buffer inventory that protects MTS service levels against demand variability
