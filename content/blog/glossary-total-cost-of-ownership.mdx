...
- [Procurement](/blog/glossary/procurement) — The function that uses TCO analysis to make better supplier and material decisions
- [Unplanned Downtime](/blog/glossary/unplanned-downtime) — A major hidden cost category that TCO analysis quantifies
- [Overall Equipment Effectiveness](/blog/glossary/oee) — The metric that captures the operational performance differences TCO compares
