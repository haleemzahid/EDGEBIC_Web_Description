...
The implementation process follows the [PDCA cycle](/blogs/glossary-pdca):
...
The [lean manufacturing guide](/blogs/lean-manufacturing-guide) positions Poka-Yoke as a core tool of the Jidoka pillar — building quality into every step so that defects never reach the customer.

## Related Terms

- **[Jidoka](/blogs/glossary-jidoka)** — The lean principle of building quality into the process that Poka-Yoke directly implements.
- **[Andon](/blogs/glossary-andon)** — The visual alert system that complements Poka-Yoke by signaling when a detection-type device identifies an error.
- **[Standard Work](/blogs/glossary-standard-work)** — Documented best practices that Poka-Yoke devices enforce through physical constraints rather than relying on human memory.
