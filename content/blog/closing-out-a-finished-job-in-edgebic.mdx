...
At completion, SPI settles at 1.00 by definition, because earned value equals planned value once everything is done. The meaningful number at close is CPI, which is earned value divided by actual cost in hours: 46.5 divided by 52.0 gives 0.89.
