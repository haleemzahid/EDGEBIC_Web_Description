...
The Pareto chart is one of the seven basic quality tools and is widely used in manufacturing for defect analysis, downtime analysis, cost reduction, customer complaint prioritization, and [root cause analysis](/blogs/glossary-root-cause-analysis). Its power lies in directing limited improvement resources toward the causes that will yield the greatest return.
...
- [Root Cause Analysis](/blogs/glossary-root-cause-analysis) — the investigation methodology applied to the vital few causes identified by Pareto analysis
- [Defect](/blogs/glossary-defect) — the nonconformances that Pareto charts categorize and prioritize
- [DMAIC](/blogs/glossary-dmaic) — the Six Sigma methodology that uses Pareto charts in its Analyze phase
