...
- [Lead Time](/blog/glossary-lead-time) — The total time from order to delivery, of which queue time is the largest component
- [Cycle Time](/blog/glossary-cycle-time) — The total production time including queue time, setup, run, and move time
- [Bottleneck](/blog/glossary-bottleneck) — The constraint resource where queue times are typically longest
