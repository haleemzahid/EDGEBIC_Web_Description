...
<Image
  src="/marketing/blog/job-shop-labor-scheduling/hero.webp"
  alt="Job shop labor scheduling board showing operators assigned to machines based on skills and availability"
  width="768"
  height="432"
