...
A **Bill of Materials (BOM)** is a structured list of every raw material, component, sub-assembly, and quantity needed to manufacture a finished product. The BOM is the foundation of [Material Requirements Planning (MRP)](/blog/glossary/material-requirements-planning) and one of the most critical data inputs for any production scheduling system.
...
When MRP processes a production order, it "explodes" the BOM — multiplying the quantity per by the number of finished units needed — to calculate [gross requirements](/blog/glossary/gross-requirements) for every component at every level.
...
MRP then checks on-hand inventory and [scheduled receipts](/blog/glossary/scheduled-receipt) to calculate [net requirements](/blog/glossary/net-requirements) — the actual quantity that must be purchased or produced.
...
- **[Material Requirements Planning (MRP)](/blog/glossary/material-requirements-planning)** — The system that explodes BOMs to calculate material needs and timing.
- **[Gross Requirements](/blog/glossary/gross-requirements)** — Total demand for a component before accounting for inventory, derived directly from BOM explosion.
- **[Dependent Demand](/blog/glossary/dependent-demand)** — Demand for components that is driven by the parent item's BOM, not by independent forecasts.
