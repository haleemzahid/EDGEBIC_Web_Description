...
- [Outbound Logistics](/blog/glossary-outbound-logistics) — The downstream counterpart handling finished goods delivery to customers
- [Procurement](/blog/glossary-procurement) — The sourcing and purchasing function that initiates inbound logistics
- [Supplier Lead Time](/blog/glossary-supplier-lead-time) — The time from purchase order to material receipt that inbound logistics must manage
