...
- [Vendor Managed Inventory](/blog/glossary/vendor-managed-inventory) — A procurement strategy where the supplier manages replenishment
- [Supplier Lead Time](/blog/glossary/supplier-lead-time) — The time from purchase order to delivery that procurement negotiates and manages
- [Total Cost of Ownership](/blog/glossary/total-cost-of-ownership) — The comprehensive cost analysis that procurement uses beyond unit price
