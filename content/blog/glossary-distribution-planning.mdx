...
- [Material Requirements Planning](/blog/glossary-material-requirements-planning) — The manufacturing planning method whose logic DRP extends to the distribution network
- [Supply Chain Management](/blog/glossary-supply-chain-management) — The broader discipline that DRP supports through coordinated inventory planning
- [Demand Planning](/blog/glossary-demand-planning) — The forecasting process that provides the demand inputs DRP uses at each location
