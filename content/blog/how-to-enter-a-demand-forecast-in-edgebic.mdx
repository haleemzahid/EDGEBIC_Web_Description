...
Once forecasts are in, you may want to freeze the near-term window so late changes do not disturb committed work: read [how to set a time fence](/blog/how-to-set-a-time-fence-in-edgebic). To see where forecast turns into a build decision, browse the [how-to hub](/blog/edgebic-how-to-hub).
