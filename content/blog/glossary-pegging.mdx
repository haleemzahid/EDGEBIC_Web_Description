...
<Image
  ...
  alt="Pegging report showing demand traced to parent orders for manufacturing glossary"
  width="768"
  height="432"
  className="w-full rounded-lg"
/>

**Pegging** is the ability within [MRP](/blogs/glossary-material-requirements-planning) to trace a component's demand back to the specific parent orders or customer orders that created it. Pegging answers the critical question: "Why do we need this part, and for whom?" It is the reverse of BOM explosion — instead of drilling down from parent to component, pegging drills up from component to parent.
...
During [BOM](/blogs/glossary-bill-of-materials) explosion, MRP calculates [gross requirements](/blogs/glossary-gross-requirements) for each component by multiplying parent order quantities by the quantity-per. Pegging records this linkage so it can be queried later.
...
A manufacturer discovers that only 300 units of component SEAL-100 are available, but MRP shows [net requirements](/blogs/glossary-net-requirements) of 500 for the current week. There is a 200-unit shortage.
...
- **[Gross Requirements](/blogs/glossary-gross-requirements)** — The total demand that pegging traces back to its originating parent orders.
- **[Bill of Materials (BOM)](/blogs/glossary-bill-of-materials)** — The product structure that defines the parent-child relationships pegging navigates.
- **[Dependent Demand](/blogs/glossary-dependent-demand)** — The type of demand that pegging traces — demand derived from parent items, not external forecasts.
