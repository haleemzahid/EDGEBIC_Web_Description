...
The habit that makes leveling work is looking at the daily load profile, not just the weekly total. A weekly total of 200 hours against 200 hours of capacity looks perfect and can still hide a 60-hour Monday. The two views answer different questions, which is the point of [how a scheduler thinks about a week vs a day](/blog/how-a-scheduler-thinks-about-a-week-vs-a-day): the near term is executable and the far term is directional. The utilization view by day shows you where the peaks are, and once you can see them, the levers above bring them down.
