...
Then confirm the result with your own actual hours rather than an estimate, which is one of the better reasons to import labor transactions early: [importing ERP labor transactions as actuals](/blog/importing-erp-labor-transactions-as-actuals) covers that path. Those same hours are what let you test the routing standards themselves, which is the method in [should you trust your ERP's standard times](/blog/should-you-trust-your-erps-standard-times).
