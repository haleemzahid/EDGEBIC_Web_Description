...
**Lean manufacturing KPIs** are the measurement system that transforms lean from a philosophy into a data-driven discipline. You cannot improve what you do not measure — and you cannot sustain improvements without metrics that make performance visible. The right KPIs tell you whether your [lean manufacturing](/blogs/lean-manufacturing-guide) initiatives are working, where to focus your next [Kaizen event](/blogs/kaizen-events-guide), and whether your production system is getting better or drifting backward. This guide covers the essential lean metrics, their formulas and benchmarks, how to build a KPI dashboard that drives action, and how to avoid the common trap of measuring everything while improving nothing.
...
**Why it matters for lean**: [OEE](/blogs/oee-overall-equipment-effectiveness) reveals hidden capacity. A 15-point OEE improvement on a constraint machine may eliminate the need for a capital equipment purchase. OEE also connects directly to the Six Big Losses tracked through [TPM](/blogs/total-productive-maintenance).
...
**Why it matters for lean**: Lead time is the ultimate flow metric. Every lean improvement — [5S](/blogs/5s-methodology-implementation), [SMED](/blogs/smed-quick-changeover), [Kanban](/blogs/kanban-system-manufacturing), continuous flow — should reduce lead time. If your lean program is working, lead time is decreasing.

**How to improve**: Reduce WIP (pull-based scheduling), reduce batch sizes (SMED enables this), create [continuous flow](/blogs/continuous-flow-manufacturing) where possible, and use [RMDB](/resource-manager-db-2) to synchronize operations.
...
**Benchmark**: Depends on equipment type. Target: less than 10 minutes for most operations ([SMED](/blogs/smed-quick-changeover) standard).
...
- [Gemba walk](/blogs/gemba-walks-guide) boards showing improvement project status alongside KPI trends
...
The most powerful use of lean KPIs is selecting and measuring [Kaizen events](/blogs/kaizen-events-guide):
