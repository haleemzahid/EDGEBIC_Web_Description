...
- **Close finished jobs on the same cadence the ERP closes them.** Add a step to the recurring routine that lists jobs not present in this week's export and closes them.
