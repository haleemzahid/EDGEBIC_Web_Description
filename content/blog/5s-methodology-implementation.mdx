...
- **[Kanban](/blogs/kanban-system-manufacturing) without 5S**: Kanban cards get lost in cluttered workstations. Replenishment signals are missed because visual controls are buried under piles of parts and paperwork.
- **[SMED](/blogs/smed-quick-changeover) without 5S**: Quick changeover requires every tool and fixture to be staged and ready. In a disorganized shop, operators spend half the setup time searching.
- **[Standard work](/blogs/standard-work-manufacturing) without 5S**: You cannot standardize a process when the work environment changes every shift.
...
Shine goes beyond housekeeping. The real purpose of Shine is to turn cleaning into inspection. When an operator wipes down a machine daily, they notice the oil leak that was not there yesterday, the cracked guard, the worn belt, the loose bolt. Shine is the earliest form of [total productive maintenance](/blogs/total-productive-maintenance).
...
**Leadership Gemba Walks**: Supervisors and managers conduct [regular Gemba walks](/blogs/gemba-walks-guide) specifically focused on 5S compliance. When leadership stops walking the floor, operators stop sustaining the standards.
...
- **[OEE improves](/blogs/oee-overall-equipment-effectiveness)** — availability increases (fewer breakdowns caught by Shine inspections), performance improves (less motion waste), and quality rises (fewer defects from organized processes)
...
**No connection to metrics**: Operators sustain what they see working. Connect 5S compliance to metrics they care about — reduced overtime, fewer lost tools, better [lean KPIs](/blogs/lean-manufacturing-kpis). If 5S feels like extra work with no payoff, it will not last.
