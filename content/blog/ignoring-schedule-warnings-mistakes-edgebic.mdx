...
**A schedule diagnostics report only helps a plant that reads it, and there are seven recognisable ways plants stop reading.** Each one is understandable, each one has a cost you can put a number on, and each one is easy to correct once it has a name.
