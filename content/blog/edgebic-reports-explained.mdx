...
That loop is the whole point of the catalog. For the wider system these reports observe, start with the [complete EDGEBIC guide](/blog/edgebic-complete-guide); for the outcomes they measure, see the [documented results](/blog/edgebic-results-guide) and the generic [manufacturing KPI reference](/blog/manufacturing-kpis-guide).

Want to see these reports over your own orders? [Bring an export to a demo](/edgebic) and we will run your jobs through the catalog.
