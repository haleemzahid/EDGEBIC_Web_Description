...
<Image
  src="/marketing/blog/production-control/hero.webp"
  alt="Factory production line with conveyor system showing shop floor execution and production monitoring"
  width="768"
  height="432"
