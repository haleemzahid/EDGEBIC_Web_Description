...
The **planning horizon** is the span of time into the future that [MRP](/blogs/glossary-material-requirements-planning) and scheduling systems use to generate [planned orders](/blogs/glossary-planned-order) and evaluate capacity needs. It defines how far ahead the manufacturer plans, and its length directly impacts the ability to procure long-lead materials and balance production capacity.
...
**Firm zone (2-6 weeks)** — Orders are mostly stable. Changes require planner approval. [Firm planned orders](/blogs/glossary-firm-planned-order) are common here.
...
- **[Planned Order](/blogs/glossary-planned-order)** — The order recommendation MRP generates within the planning horizon.
- **[Firm Planned Order](/blogs/glossary-firm-planned-order)** — An order locked by the planner, typically within the firm zone of the planning horizon.
- **[Time Bucket](/blogs/glossary-time-bucket)** — The period size (day, week, month) used to divide the planning horizon into manageable segments.
