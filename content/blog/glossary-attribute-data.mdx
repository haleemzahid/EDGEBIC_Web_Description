...
**Attribute data** is a type of qualitative data used in manufacturing quality control that classifies items into discrete categories. Each inspected item is categorized as either conforming or nonconforming, pass or fail, defective or acceptable. Unlike [variable data](/blog/glossary/variable-data) which measures a continuous characteristic on a numerical scale, attribute data deals in counts and classifications.
...
Attribute data feeds into several [SPC](/blog/glossary/spc) chart types. The [p-chart](/blog/glossary/p-chart) tracks the proportion of defective items in each sample. The [np-chart](/blog/glossary/np-chart) tracks the number of defective items when sample sizes are constant. The [c-chart](/blog/glossary/c-chart) tracks the count of defects per inspection unit. Each chart type has specific assumptions and use cases that the quality team must understand to select the correct tool.
...
- [Variable Data](/blog/glossary/variable-data) — continuous measurement data that provides more information per sample than attribute data
- [Control Chart](/blog/glossary/control-chart) — statistical charts used to monitor attribute and variable data over time
- [P-Chart](/blog/glossary/p-chart) — the most common control chart for attribute data tracking proportion defective
