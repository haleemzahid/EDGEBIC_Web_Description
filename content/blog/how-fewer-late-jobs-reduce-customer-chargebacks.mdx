...
Most scheduling savings are costs you avoid: setup hours not worked, [the premium freight a stable schedule never needs](/blog/why-a-stable-schedule-cuts-premium-freight), overtime not authorized. Chargebacks are worse than a cost. They are revenue subtracted after you have already spent the material and the labor to produce the order.
