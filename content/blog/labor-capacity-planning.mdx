...
Now compare each skill group's capacity against the labor demand generated by your work orders. If welding demand is 80 hours per week against 68 hours of capacity, welding labor is your [constraint](/blogs/resource-constraints-manufacturing) — even if the welding stations have physical capacity to spare.
...
Your [finite capacity planning](/blogs/what-is-finite-capacity-planning) system needs to model these ratios accurately. RMDB supports multi-resource scheduling where an operation requires both a specific machine and a labor resource from a specific skill group — and is only scheduled when both are simultaneously available.
...
1. Train backup operators for [bottleneck resources](/blogs/theory-of-constraints-scheduling) first
