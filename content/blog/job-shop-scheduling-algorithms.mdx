...
<Image
  src="/marketing/blog/job-shop-scheduling-algorithms/hero.webp"
  alt="Flowchart showing different job shop scheduling algorithms from simple dispatching rules to advanced optimization"
  width="768"
  height="432"
