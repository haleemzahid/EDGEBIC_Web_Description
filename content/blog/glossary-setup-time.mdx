...
- [Run Time](/blogs/glossary-run-time) — The productive processing time that follows setup time in each operation
- [Sequencing](/blogs/glossary-sequencing) — The ordering of jobs that can minimize sequence-dependent setup times
- [Takt Time](/blogs/glossary-takt-time) — The required production rate that setup time reductions help achieve
