...
**It says nothing about whether the operation should exist.** A routing can have perfectly accurate hours for a step that should have been combined with the next one. That question is answered by the BOR Optimization Suggestions report and by process engineering, not by variance.
