...
A **time bucket** is the unit of time — typically a day, week, or month — into which [MRP](/blogs/glossary-material-requirements-planning) groups demand, supply, and planned actions. Time buckets divide the [planning horizon](/blogs/glossary-planning-horizon) into discrete periods, and all requirements and receipts within a bucket are treated as occurring within that period.
...
|---|----------|----------|----------|----------|
| [Gross Requirements](/blogs/glossary-gross-requirements) | 120 | 80 | 150 | 95 |
| [Scheduled Receipts](/blogs/glossary-scheduled-receipt) | 0 | 200 | 0 | 0 |
| Projected On-Hand | 30 | 150 | 0 | -95 |
| [Planned Orders](/blogs/glossary-planned-order) | 0 | 0 | 0 | 95 |
...
**They affect [lot sizing](/blogs/glossary-lot-sizing) decisions.** Lot-for-lot in weekly buckets combines all demand within the week into one order. In daily buckets, each day may generate a separate order. The same lot-sizing rule produces different results depending on bucket size.

**They impact capacity planning.** [CRP](/blogs/glossary-crp) loads capacity by time bucket. Weekly CRP might show 85% utilization — acceptable. Daily CRP might reveal Monday at 120% and Friday at 50% — a very different picture.
...
- **[Planning Horizon](/blogs/glossary-planning-horizon)** — The total time span divided into time buckets for MRP planning.
- **[Net Requirements](/blogs/glossary-net-requirements)** — The per-bucket calculation of what must be ordered or produced.
- **[Capacity Requirements Planning (CRP)](/blogs/glossary-crp)** — The capacity check that loads hours into time buckets to identify overloads.
