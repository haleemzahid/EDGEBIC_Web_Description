...
- [Safety Stock](/blog/glossary/safety-stock) — Buffer inventory whose optimal level depends on accurate inventory records
- [Material Requirements Planning](/blog/glossary/material-requirements-planning) — The planning system that relies on accurate on-hand balances to generate correct orders
- [Kanban](/blog/glossary/kanban) — A pull replenishment system that works best when inventory counts are reliable
