...
A work center either uses the plant-wide shift catalogue or its own local shift records, controlled by one setting on the machine. Local shifts come in two useful forms.
