...
Related definitions are [what is a shop floor kiosk](/blog/what-is-a-shop-floor-kiosk) for the terminal where the counts originate, [pieces per hour](/blog/what-is-pieces-per-hour-in-work-center-capacity) for the rate that connects the two sides, and [what is planned vs actual hours](/blog/what-is-planned-vs-actual-hours) for how the captured numbers are compared against the plan. For the mechanism in full, see [how hours and pieces convert on the floor](/blog/how-hours-and-pieces-convert-on-the-floor).
