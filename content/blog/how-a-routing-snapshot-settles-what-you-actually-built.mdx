...
Add the logged actuals and you have both halves of the story: what the job was supposed to do, and what it actually did. The same records are what [narrow a quality investigation to a specific machine, operator, and shift](/blog/how-the-production-record-shortens-a-quality-investigation). The dates, hours, and work centers on completed operations are preserved exactly as logged, because completed work is never moved by a reschedule.
