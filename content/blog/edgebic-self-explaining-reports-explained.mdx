...
The reports themselves are cataloged in the [report overview](/blog/edgebic-reports-explained); the click-by-click version of the dialog is in [how to use Column Details](/blog/how-to-use-column-details-in-edgebic).
