...
None of those produce an error message. They produce a plan that looks entirely normal and is wrong in one specific place. Data quality is the recognized weak point in manufacturing systems generally, and organizations such as [NIST MEP](https://www.nist.gov/mep) build much of their manufacturing improvement guidance around getting the underlying records right before layering tools on top.
