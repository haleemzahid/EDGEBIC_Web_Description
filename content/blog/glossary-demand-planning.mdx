...
- [Master Production Schedule](/blogs/glossary-master-production-schedule) — The production plan that translates the demand forecast into specific manufacturing quantities and timing
- [Demand Variability](/blogs/glossary-demand-variability) — The fluctuation in demand that demand planning attempts to predict and manage
- [Safety Stock](/blogs/glossary-safety-stock) — The inventory buffer that protects against demand forecast errors
