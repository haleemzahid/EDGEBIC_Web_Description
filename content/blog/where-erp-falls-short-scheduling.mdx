...
<Image
  src="/marketing/blog/where-erp-falls-short-scheduling/hero.webp"
  alt="Split screen showing ERP scheduling output versus actual shop floor reality with mismatched timelines"
  width="1200"
  height="630"
