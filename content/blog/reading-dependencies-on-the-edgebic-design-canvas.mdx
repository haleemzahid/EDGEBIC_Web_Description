...
Manufacturers have reasoned about routings as flows for as long as there have been routings, and User Solutions has been putting that flow on a screen since 1991. The discipline is small and pays every day: before you trust a routing, follow its arrows from first step to finished product and confirm every merge has its inputs and every node has a way out. Check the type of each arrow while you are there, because [parallel and alternate branches on the canvas](/blog/reading-parallel-and-alternate-branches-on-the-edgebic-canvas) schedule nothing like a plain next-in-sequence link. A [dependency violation](/blog/what-is-a-dependency-violation-in-scheduling) that would have surfaced as a strange schedule three days from now surfaces instead as an arrow that is missing today.
