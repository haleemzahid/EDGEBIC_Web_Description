...
For how the dates in that same run are produced, see [how a quote simulation produces a realistic date](/blog/how-a-quote-simulation-produces-a-realistic-date), and for every field the run fills in, see [reading the simulated quote result field by field](/blog/reading-the-simulated-quote-result-in-edgebic).
