...
**How to tell:** the hours sit on a day the shift is closed, or far from the overnight window, not merely on the start day. Hours sitting on a date the operation's own bar does not cover are a separate case, covered in [hours landed on a date outside the operation window](/blog/hours-landed-on-a-date-outside-the-operation-window-edgebic).
