...
- **I checks** cover inventory integrity. I3 flags a negative on-hand balance (more issued than received); I1 flags on-hand cache drift where the stored quantity disagrees with the ledger sum.
