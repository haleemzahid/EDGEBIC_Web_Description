...
**Obsolete inventory** is stock that can no longer be used in production or sold to customers because it has been superseded, discontinued, or rendered unusable by specific, identifiable causes. Unlike [dead stock](/blogs/glossary-dead-stock), which simply has not moved, obsolete inventory has a definitive reason for being unusable — an engineering change, a product discontinuation, a regulatory prohibition, or shelf-life expiration.

Obsolete inventory represents a direct financial loss. The full acquisition cost of the material plus accumulated [carrying costs](/blogs/glossary-carrying-cost) must be written off against earnings. For manufacturers, obsolescence write-offs can be significant — industry surveys indicate that manufacturers lose 1-3% of annual revenue to inventory obsolescence.
...
**Identification.** Regular inventory aging reviews flag items that have not moved for 6, 9, and 12 months. Engineering change orders are cross-referenced against current inventory to identify affected materials immediately. [ABC analysis](/blogs/glossary-abc-analysis) prioritizes the review — high-value A items warrant the most attention.
...
- [Dead Stock](/blogs/glossary-dead-stock) — slow-moving inventory that may eventually become obsolete
- [FIFO](/blogs/glossary-fifo) — inventory rotation method that helps prevent shelf-life obsolescence
- [Carrying Cost](/blogs/glossary-carrying-cost) — the ongoing expense of holding obsolete inventory before disposition
