...
Scheduling software like [Resource Manager DB](/resource-manager-db-2) depends on accurate inventory data. Prompt identification and segregation of obsolete inventory ensures the scheduler works with a true picture of available materials.
