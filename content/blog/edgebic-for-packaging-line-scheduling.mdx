...
For the mechanism in general terms, read [queue and transit times explained](/blog/edgebic-queue-and-transit-times-explained). When the filler, capper, and labeler have to move as one event rather than merely stay fed, the mechanism is different: see [scheduling machines that must run in lockstep](/blog/edgebic-for-packaging-multi-machine-lines). For the category-level view of this sector, see [packaging manufacturing scheduling](/blog/packaging-manufacturing-scheduling), and for the cross-industry map, [how different industries use EDGEBIC](/blog/edgebic-by-industry).
