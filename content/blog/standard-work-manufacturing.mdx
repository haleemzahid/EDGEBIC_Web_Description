...
This visual document is posted at the workstation so anyone — including new operators, supervisors, and [Gemba walkers](/blogs/gemba-walks-guide) — can see whether the process is being followed.
...
Every [Kaizen event](/blogs/kaizen-events-guide) that changes the process should produce an updated standard work document. Every [SMED](/blogs/smed-quick-changeover) improvement, every [poka-yoke](/blogs/poka-yoke-error-proofing) addition, every layout change triggers a standard work revision. The document evolves with the process.
...
**Reduced variability**: Without standard work, cycle times might range from 8-14 minutes depending on the operator. With standard work, the range narrows to 9-11 minutes. Narrower ranges mean more accurate schedules and better [on-time delivery](/blogs/lean-manufacturing-kpis).
