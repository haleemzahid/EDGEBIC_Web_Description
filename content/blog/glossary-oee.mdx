...
- [Planned Downtime](/blogs/glossary-planned-downtime) — Scheduled maintenance time that is excluded from OEE planned production time in some models
- [Unplanned Downtime](/blogs/glossary-unplanned-downtime) — Unexpected equipment failures that directly reduce OEE availability
- [First Pass Yield](/blogs/glossary-first-pass-yield) — The quality component closely related to OEE's quality factor
