...
### Level 4: Predictive
Models forecast "What will happen?" [Predictive maintenance](/blogs/predictive-maintenance) from vibration data, demand forecasting from order patterns, quality prediction from process parameters.

### Level 5: Prescriptive
Systems recommend "What should we do?" [AI-optimized scheduling](/blogs/ai-in-manufacturing), automated reordering, self-adjusting process parameters. Few manufacturers reach this level consistently.
...
**Source**: [IoT sensors](/blogs/iot-manufacturing), machine controllers, manual logs

**Decisions it drives**: [Maintenance scheduling](/blogs/predictive-maintenance), capital investment, capacity planning, scheduling accuracy improvement

### 3. Quality Data

**What to capture**: First-pass yield, scrap rate by operation/machine/part, [SPC measurements](/blogs/statistical-process-control-spc), customer complaints, rework hours
...
**Source**: ERP, [MRP systems](/blogs/mrp-material-requirements-planning-guide), purchasing records
...
Implement [production scheduling software](/blogs/production-scheduling-software-guide) that creates a structured model of your production process. This gives you:
- A baseline capacity model (hours per resource, shifts per week)
- Planned times to compare against actual
- [Finite capacity constraints](/blogs/finite-capacity-planning-guide) that reveal where your real bottlenecks are
- Schedule adherence tracking — the single most diagnostic [manufacturing KPI](/blogs/manufacturing-kpis-guide)
...
- **Updated**: At least daily. Real-time through [IoT](/blogs/iot-manufacturing) is better.
...
|---|---|---|
| [On-time delivery](/blogs/on-time-delivery-kpi) | 95%+ | Review scheduling accuracy, identify late root causes |
...
| First-pass yield | 95%+ | [Root cause analysis](/blogs/root-cause-analysis) on top defects |
| [Throughput rate](/blogs/throughput-rate-manufacturing) | Per baseline | Check bottleneck, scheduling, and downtime |
