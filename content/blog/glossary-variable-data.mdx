...
This richness makes variable data the preferred data type for [SPC](/blogs/glossary-spc) whenever measurement is practical. Variable data control charts ([X-bar charts](/blogs/glossary-x-bar-chart), [R-charts](/blogs/glossary-r-chart)) are more sensitive to process changes than attribute charts, require smaller sample sizes, and enable [capability analysis](/blogs/glossary-capability-index) — the comparison of process performance to [specification limits](/blogs/glossary-specification-limits).
...
- [Attribute Data](/blogs/glossary-attribute-data) — qualitative data that classifies items into discrete categories, complementing variable data
- [X-bar Chart](/blogs/glossary-x-bar-chart) — the primary variable data control chart for monitoring process average
- [Capability Index](/blogs/glossary-capability-index) — process performance measures calculated exclusively from variable data
