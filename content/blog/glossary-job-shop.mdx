...
- [Discrete Manufacturing](/blogs/glossary-discrete-manufacturing) — The broader manufacturing category that includes job shops
- [Sequencing](/blogs/glossary-sequencing) — The process of determining the order in which jobs are processed at each work center
- [Shop Floor](/blogs/glossary-shop-floor) — The physical production area where job shop work is executed
