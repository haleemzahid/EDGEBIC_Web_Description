...
- [Slack Time](/blog/glossary/slack-time) — The amount of time a non-critical operation can be delayed without affecting the overall schedule
- [Lead Time](/blog/glossary/lead-time) — The total time from order start to completion, determined by the critical path
- [Makespan](/blog/glossary/makespan) — The total duration from start to finish of a set of jobs, closely related to critical path analysis
