...
Manufacturers use multiple strategies to manage defects. **Prevention** aims to design processes that cannot produce defects — through [FMEA](/blogs/glossary-fmea), mistake-proofing (poka-yoke), and robust process design. **Detection** uses [inspection](/blogs/glossary-inspection), testing, and [SPC](/blogs/glossary-spc) to find defects before they reach the customer. **Analysis** uses tools like [Pareto charts](/blogs/glossary-pareto-chart) and [root cause analysis](/blogs/glossary-root-cause-analysis) to understand defect patterns and drive improvement.
...
Production scheduling software like [Resource Manager DB](/manufacturing-scheduling-software) allows planners to incorporate expected yield rates into their schedules, ensuring sufficient material is released and adequate capacity is reserved to meet net production requirements despite anticipated defects.
...
- [Scrap Rate](/blogs/glossary-scrap-rate) — the percentage of production lost to irreparable defects
- [First Pass Yield](/blogs/glossary-first-pass-yield) — the percentage of units that pass inspection without rework
- [Root Cause Analysis](/blogs/glossary-root-cause-analysis) — the methodology for finding the fundamental cause of defects
