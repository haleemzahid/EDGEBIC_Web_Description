...
**Finished goods** are completed manufactured products that have passed through all production operations, assembly steps, and quality [inspections](/blog/glossary-inspection) and are ready for sale, shipment, or delivery to customers. They represent the final category in the manufacturing inventory lifecycle: [raw materials](/blog/glossary-raw-materials) enter the factory, become [work-in-process (WIP)](/blog/glossary-wip-inventory) during manufacturing, and emerge as finished goods upon completion.
...
The amount of finished goods inventory a manufacturer holds is a strategic decision that balances customer service levels against inventory investment. [Make-to-stock](/blog/glossary-make-to-stock) manufacturers maintain finished goods buffers to provide immediate product availability. [Make-to-order](/blog/glossary-make-to-order) manufacturers produce finished goods only against customer orders, minimizing or eliminating finished goods inventory.
...
**[Inventory turnover](/blog/glossary-inventory-turnover):** How many times per year the finished goods inventory is sold and replaced. Higher turnover means less capital tied up in inventory.

**[Days inventory outstanding](/blog/glossary-days-inventory-outstanding):** The average number of days finished goods sit in inventory before being shipped. Lower is generally better.

**[Service level](/blog/glossary-service-level):** The percentage of customer orders that can be fulfilled immediately from finished goods stock. Higher service levels require more inventory.
...
This segmented strategy balances customer service with inventory investment. The top 15 models justify finished goods investment because their high demand velocity ensures rapid [inventory turnover](/blog/glossary-inventory-turnover). The slower-moving standard models and all custom configurations avoid the carrying cost of finished goods inventory.
...
- [WIP Inventory](/blog/glossary-wip-inventory) — partially completed items in the production process that precede finished goods
- [Raw Materials](/blog/glossary-raw-materials) — unprocessed inputs that are the starting point of the manufacturing inventory cycle
- [Make-to-Stock](/blog/glossary-make-to-stock) — the production strategy that requires finished goods inventory buffers
