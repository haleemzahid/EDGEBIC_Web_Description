...
**A items:** Tight inventory controls, frequent [cycle counting](/blog/glossary/cycle-counting), accurate demand forecasting, close supplier relationships, low [safety stock](/blog/glossary/safety-stock-glossary) based on precise calculations, and frequent [reorder point](/blog/glossary/reorder-point) reviews.
...
By focusing management attention on the 180 A items, the company reduces inventory carrying costs by $185,000 per year while simultaneously improving availability of critical items and reducing [stockouts](/blog/glossary/stockout) on A items by 40%.
...
- [Carrying Cost](/blog/glossary/carrying-cost) — the cost of holding inventory, which ABC analysis helps minimize by tailoring stock levels
- [Safety Stock](/blog/glossary/safety-stock-glossary) — buffer inventory levels that are differentiated by ABC classification
- [Cycle Counting](/blog/glossary/cycle-counting) — inventory accuracy method that prioritizes counting frequency by ABC category
