...
- [Setup Time](/blogs/glossary-setup-time) — Often used interchangeably with changeover time in scheduling systems
- [Single-Minute Exchange of Die](/blogs/glossary-single-minute-exchange) — The lean methodology for reducing changeover time below 10 minutes
- [Run Time](/blogs/glossary-run-time) — The productive processing time that changeover reduction aims to maximize
