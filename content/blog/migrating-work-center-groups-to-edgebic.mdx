...
Pair this with the load check from [migrating capacity and utilization settings](/blog/migrating-capacity-and-utilization-settings-to-edgebic), because a pool's behavior depends on its members' capacity being right first.
