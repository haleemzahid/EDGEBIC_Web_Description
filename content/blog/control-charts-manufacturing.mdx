...
**[X-bar and R Charts](/blogs/x-bar-r-charts)**: The most common control chart pair. The X-bar chart monitors subgroup averages (process centering) while the R chart monitors subgroup ranges (process spread). Used when you collect small subgroups (2-10 samples) at regular intervals.
...
**[p-Chart](/blogs/p-chart-quality-control)**: Monitors the proportion of defective items in a sample. Sample sizes can vary. Most versatile attribute chart.
...
|---|---|---|
| Continuous (dimension, weight) | Subgroups of 2-10 | [X-bar and R](/blogs/x-bar-r-charts) |
| Continuous | Subgroups > 10 | X-bar and S |
| Continuous | Individual measurements | I-MR |
| Attribute (defective/good) | Varying sample size | [p-chart](/blogs/p-chart-quality-control) |
...
[Production scheduling](/blogs/what-is-production-scheduling) and control charts interact in important ways:
