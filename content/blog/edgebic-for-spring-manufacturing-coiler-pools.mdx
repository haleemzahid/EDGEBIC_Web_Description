...
Coil winders pool the same way, though their constraint sits downstream in a vessel that takes one load at a time: see [scheduling transformer and coil winding around the impregnation cycle](/blog/edgebic-for-transformer-and-coil-winding-scheduling).
