...
If you have not met the catalog yet, start with the [report overview](/blog/edgebic-reports-explained); for the mechanics of filters and exports, the [running and exporting guide](/blog/how-to-run-filter-and-export-reports-in-edgebic) covers them.
