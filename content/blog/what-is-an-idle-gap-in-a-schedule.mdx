...
If the symptom is a recurring, unexplained gap rather than a one-off, the troubleshooting walkthrough for [a schedule with idle gaps](/blog/schedule-has-idle-gaps-edgebic) steps through the diagnosis. For the full catalogue of checks, read [what the EDGEBIC anomaly checks actually look for](/blog/what-the-edgebic-anomaly-checks-actually-look-for).
