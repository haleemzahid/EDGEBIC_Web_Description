...
2. **MRP explosion** calculates material requirements from the [Bill of Materials](/blog/glossary/bill-of-materials).
...
5. **Order release** sends feasible [work orders](/blog/glossary/work-order) and [purchase orders](/blog/glossary/purchase-order) to the shop floor and suppliers.
...
- **[Capacity Requirements Planning (CRP)](/blog/glossary/crp)** — The capacity validation step that makes MRP "closed-loop."
- **[Manufacturing Resource Planning (MRP II)](/blog/glossary/mrp-ii)** — The evolution of closed-loop MRP that adds financial and business planning.
- **[Regenerative MRP](/blog/glossary/regenerative-mrp)** — A full MRP recalculation method often used within closed-loop systems.
