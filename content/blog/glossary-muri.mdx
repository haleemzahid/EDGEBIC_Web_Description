...
**Muri** is the Japanese lean manufacturing term for overburden — pushing people, equipment, or processes beyond their sustainable capacity. Together with [Muda](/blog/glossary/muda) (waste) and [Mura](/blog/glossary/mura) (unevenness), Muri completes the "three Ms" that lean seeks to eliminate. While Muda gets the most attention, Muri is often the most destructive because it leads to equipment failures, quality defects, safety incidents, and employee burnout. This [manufacturing glossary](/blog/manufacturing-glossary) entry explains Muri, shows its real cost, and demonstrates how scheduling prevents it.
...
The relationship between the three Ms is cyclical: [Mura](/blog/glossary/mura) (uneven demand) causes Muri (overburden during peaks), which causes [Muda](/blog/glossary/muda) (waste from breakdowns, defects, and recovery efforts).
...
The [lean manufacturing guide](/blog/lean-manufacturing-guide) explains that sustainable production — not maximum short-term output — is the goal of a lean system.

## Related Terms

- **[Muda (Waste)](/blog/glossary/muda)** — The waste that Muri generates through breakdowns, defects, and inefficiency caused by overburden.
- **[Mura (Unevenness)](/blog/glossary/mura)** — The demand fluctuations that cause Muri by creating unsustainable peak workloads.
- **[Total Productive Maintenance](/blog/glossary/tpm)** — The maintenance strategy that prevents equipment Muri by ensuring machines are maintained before they break down.
