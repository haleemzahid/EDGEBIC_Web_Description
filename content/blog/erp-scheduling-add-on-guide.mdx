...
<Image
  src="/marketing/blog/erp-scheduling-add-on-guide/hero.webp"
  alt="ERP scheduling add-on integration diagram showing production scheduling connected to enterprise systems"
  width="1200"
  height="630"
