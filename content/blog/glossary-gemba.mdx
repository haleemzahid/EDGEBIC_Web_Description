...
The [lean manufacturing guide](/blogs/lean-manufacturing-guide) emphasizes that lean cannot be managed from a desk — Gemba is how leaders stay connected to the reality of production.

## Related Terms

- **[Kaizen](/blogs/glossary-kaizen)** — Continuous improvement philosophy that Gemba walks support by surfacing real problems from the shop floor.
- **[Visual Management](/blogs/glossary-visual-management)** — Visual boards and signals that make abnormalities visible during Gemba walks.
- **[Standard Work](/blogs/glossary-standard-work)** — The documented best practice that Gemba walks verify is being followed consistently.
