...
- [Scrap Rate](/blog/glossary-scrap-rate) — Defective units that cannot be reworked and must be discarded entirely
- [First Pass Yield](/blog/glossary-first-pass-yield) — The metric measuring the percentage of units that require no rework
- [Root Cause Analysis](/blog/glossary-root-cause-analysis) — The investigation method used to identify and eliminate the sources of rework
