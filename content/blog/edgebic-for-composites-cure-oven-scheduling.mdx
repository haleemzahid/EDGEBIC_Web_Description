...
For a related batch application, see [heat treat furnace scheduling](/blog/edgebic-for-heat-treating-furnace-scheduling), for the version where the tool rather than the oven is the finite unit, [scheduling boat building around molds, cure time, and launch dates](/blog/edgebic-for-boat-building-and-marine-scheduling), and for the fundamentals, [finite versus infinite capacity scheduling](/blog/finite-vs-infinite-capacity-scheduling). The [industry fit guide](/blog/edgebic-by-industry) maps the rest, and [EDGEBIC](/edgebic) is the product hub.
