...
- [Throughput](/blogs/glossary-throughput) — The rate at which WIP converts to finished goods
- [Cycle Time](/blogs/glossary-cycle-time) — The time to complete one unit through an operation, a key driver of WIP levels
- [Kanban](/blogs/glossary-kanban) — A pull system that limits WIP by controlling the number of active jobs
