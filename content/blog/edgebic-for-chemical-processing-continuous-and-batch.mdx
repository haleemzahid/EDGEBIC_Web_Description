...
Fermenters and stills are the same shape of problem on a longer clock: [tank scheduling for craft brewing and distilling](/blog/edgebic-for-craft-brewing-and-distilling-tank-scheduling) models each vessel as a single load held for its full cycle.
