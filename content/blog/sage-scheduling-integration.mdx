...
- Direct database read for data extraction

Across all of these, the route User Solutions uses is the file export or the database read, mapped once through a saved import mask. EDGEBIC by User Solutions does not ship a Sage-specific connector, which is why the same approach covers Sage 100, 300, X3, and Intacct without four separate integrations.
