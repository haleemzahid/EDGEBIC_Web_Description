...
None of these are errors that stop a run. They are warnings that a configuration does not mean what someone thought it meant, which is a far more common failure than a crash. The full catalogue is in [what the anomaly checks look for](/blog/what-the-edgebic-anomaly-checks-actually-look-for).
