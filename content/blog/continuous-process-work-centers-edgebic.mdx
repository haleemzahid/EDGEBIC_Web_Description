...
Both checks exist because both combinations are legal to enter and ambiguous in intent. [What the anomaly checks actually look for](/blog/what-the-edgebic-anomaly-checks-actually-look-for) covers the full catalog, and [lot streaming mistakes](/blog/lot-streaming-mistakes-edgebic) covers the symptoms with fixes.
