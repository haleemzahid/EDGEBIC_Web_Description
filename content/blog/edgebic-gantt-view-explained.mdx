...
description: "How the EDGEBIC Job Gantt view shows the plan and the reality on one bar chart, with routing dependencies drawn between operations and drag-to-reschedule that stages before it commits."
