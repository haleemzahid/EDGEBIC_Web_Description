...
4. **Material Requirements Planning** — explodes [BOMs](/blogs/glossary-bill-of-materials) and calculates component needs.
5. **[Capacity Requirements Planning (CRP)](/blogs/glossary-crp)** — validates that material plans are feasible against machine and labor capacity.
6. **Shop Floor Control** — releases [work orders](/blogs/glossary-work-order), tracks progress, and reports completions.
7. **Purchasing Execution** — manages [purchase orders](/blogs/glossary-purchase-order) and supplier performance.
8. **Financial Integration** — converts production plans into budgets, cost variances, and cash flow projections.

The key innovation of MRP II over basic MRP was **closing the loop** — feeding execution data back into planning and validating feasibility at every level. This is the [closed-loop MRP](/blogs/glossary-closed-loop-mrp) concept taken to its logical conclusion.
...
- **[Material Requirements Planning (MRP)](/blogs/glossary-material-requirements-planning)** — The core material planning engine that MRP II extends with capacity and financial modules.
- **[Enterprise Resource Planning (ERP)](/blogs/glossary-enterprise-resource-planning)** — The modern evolution of MRP II that adds non-manufacturing business functions.
- **[Closed-Loop MRP](/blogs/glossary-closed-loop-mrp)** — The feedback-driven planning approach that MRP II formalized into a complete system.
