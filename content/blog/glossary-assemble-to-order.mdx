...
- [Make-to-Order](/blogs/glossary-make-to-order) — A strategy with longer lead times where all production is triggered by customer orders
- [Configure-to-Order](/blogs/glossary-configure-to-order) — A related strategy that adds software or parameter configuration to physical assembly
- [Subassembly](/blogs/glossary-subassembly) — The pre-built modules that form the building blocks of ATO products
