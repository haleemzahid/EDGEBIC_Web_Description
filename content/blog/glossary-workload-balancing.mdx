...
- [Resource Leveling](/blog/glossary-resource-leveling) — A related technique that smooths workload over time periods rather than across parallel resources
- [Loading](/blog/glossary-loading) — The assignment of work to resources that workload balancing optimizes
- [Utilization](/blog/glossary-utilization) — The metric that reveals workload imbalances across resources
