...
<Image
  ...
  alt="Economic Order Quantity EOQ cost curve diagram for manufacturing glossary"
  width="768"
  height="432"
  className="w-full rounded-lg"
/>

**Economic Order Quantity (EOQ)** is a formula-based [lot sizing](/blogs/glossary-lot-sizing) method that calculates the optimal order quantity to minimize the total cost of ordering and holding inventory. EOQ balances two competing costs: the cost of placing orders (or setting up production) against the cost of carrying inventory in the warehouse.
...
**Feeds into MRP lot sizing.** When [MRP](/blogs/glossary-material-requirements-planning) calculates [net requirements](/blogs/glossary-net-requirements), it needs a lot-sizing rule to determine how to group requirements into orders. EOQ is one of the most common methods, especially for purchased components with steady usage.
...
- **[Lot Sizing](/blogs/glossary-lot-sizing)** — The broader category of methods for determining order quantities, of which EOQ is one approach.
- **[Lot-for-Lot](/blogs/glossary-lot-for-lot)** — An alternative lot-sizing method that orders exactly what is needed each period, with zero excess inventory.
- **[Safety Stock](/blogs/glossary-safety-stock)** — Buffer inventory held to protect against demand variability, often used alongside EOQ to handle uncertainty.
