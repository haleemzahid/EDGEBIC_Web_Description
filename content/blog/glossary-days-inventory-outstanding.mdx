...
- [WIP Inventory](/blog/glossary-wip-inventory) — Work-in-process inventory that directly contributes to DIO
- [Safety Stock](/blog/glossary-safety-stock) — Buffer inventory that increases DIO when set too high
- [Economic Order Quantity](/blog/glossary-economic-order-quantity) — A lot sizing method that balances ordering and holding costs
