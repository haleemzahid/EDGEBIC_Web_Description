...
This compound effect is why shops that implement both scheduling software and setup reduction methodologies simultaneously see larger improvements than the sum of each individually. The [ROI of scheduling software](/blog/scheduling-software-roi) increases when setup time is captured in the scheduling model.
