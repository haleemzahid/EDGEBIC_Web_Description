...
What you actually want is the input side: is this station taking on more than it can clear? That question has an answer weeks earlier, and it is a different number: [backlog in capacity scheduling](/blog/what-is-backlog-in-capacity-scheduling), the forward sum of remaining hours a work center still owes.
