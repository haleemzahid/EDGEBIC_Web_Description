...
- **High utilization at non-constraints creates WIP without adding throughput.** It is [overproduction](/blog/7-wastes-lean-manufacturing) — waste, not productivity.
...
The constraint is the resource with the highest [load-to-capacity ratio](/blog/resource-constraints-manufacturing). Calculate this ratio for every resource:
...
- Add overtime or a shift at the constraint ([targeted, not blanket](/blog/overcoming-capacity-constraints))
...
[Finite capacity scheduling software](/blog/capacity-planning-software) like RMDB operationalizes TOC by:
...
Work orders are released to the shop floor based on the constraint schedule, not due dates alone. This prevents WIP buildup and maintains short [manufacturing cycle times](/blog/manufacturing-cycle-time).
...
TOC and [lean manufacturing](/blog/lean-manufacturing-guide) are not competing philosophies — they are complementary:

- **TOC tells you where to focus**: the constraint
- **Lean tells you how to improve**: eliminate waste, reduce changeovers (SMED), improve maintenance (TPM), organize the workplace ([5S](/blog/5s-methodology-implementation))
...
4. **Set up [capacity buffers](/blog/capacity-buffers-safety-capacity)**: time buffers before the constraint and before shipping
5. **Implement [finite capacity scheduling](/blog/finite-capacity-planning-guide)**: automate DBR with software that respects TOC principles

**Ready to schedule with TOC principles?** [Request a demo of RMDB](https://usersolutions.com/contact-us) and see how constraint-based scheduling maximizes your throughput while minimizing WIP and lead times.
