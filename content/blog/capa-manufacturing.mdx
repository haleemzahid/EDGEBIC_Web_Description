...
CAPA is required by [ISO 9001](/blog/iso-9001-manufacturers) (Clause 10.2), IATF 16949, AS9100, and virtually every quality management standard. For the broader quality context, see our [quality control manufacturing guide](/blog/quality-control-manufacturing-guide).
...
Apply [root cause analysis](/blog/root-cause-analysis) methods:
...
- **Data analysis**: Review [SPC charts](/blog/control-charts-manufacturing), production records, [scheduling data](/blog/what-is-production-scheduling), and maintenance logs
...
- "Implement [SPC monitoring](/blog/statistical-process-control-spc) on bore diameter operation. Responsible: Quality engineer. Due: April 15."
...
- Check [control charts](/blog/control-charts-manufacturing) for improvement
...
- Update [FMEA](/blog/fmea-manufacturing) for affected processes
- Revise work instructions and training materials
- Modify standard [scheduling practices](/blog/finite-capacity-planning-guide) if scheduling was a contributing factor
- Share lessons learned across the organization

### Step 8: Close and Review
Close the CAPA with documented evidence of implementation and effectiveness. Include the CAPA in management review per [ISO 9001](/blog/iso-9001-manufacturers) requirements. Archive for future reference.
...
**Problem**: [Control chart](/blog/control-charts-manufacturing) shows special cause variation concentrated on Saturday overtime shifts.
...
When CAPA reveals scheduling as a root cause, [RMDB](/resource-manager-db-2) provides the corrective action: [finite capacity scheduling](/blog/finite-capacity-planning-guide) that prevents rushed production, manages overtime, and schedules quality operations as mandatory steps. Track CAPAs with [Spreadsheet QC](/spreadsheet-qc). [Contact User Solutions](/contact-us) to close the loop.
