...
- [Make-to-Order](/blogs/glossary-make-to-order) — A strategy where existing designs are produced when orders are received, without the ETO engineering phase
- [Manufacturing Lead Time](/blogs/glossary-manufacturing-lead-time) — The production duration that follows the engineering phase in ETO
- [Critical Path](/blogs/glossary-critical-path) — The longest sequence of dependent tasks that determines ETO project completion date
