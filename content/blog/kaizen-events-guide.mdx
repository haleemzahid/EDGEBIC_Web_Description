...
- A specific process or area has been identified as a bottleneck or waste source — often through [value stream mapping](/blog/value-stream-mapping-guide)
...
- [Lean KPIs](/blog/lean-manufacturing-kpis) show a specific metric underperforming (high setup times, low [OEE](/blog/oee-overall-equipment-effectiveness), excessive WIP)
...
**Select the target area**: Use your value stream map, [Gemba walk](/blog/gemba-walks-guide) observations, or KPI data to identify where improvement will deliver the most impact. Common Kaizen event targets include:

- Reducing changeover/setup time ([SMED events](/blog/smed-quick-changeover))
- Improving work cell layout and flow
- Reducing WIP between operations
- Implementing [5S](/blog/5s-methodology-implementation) in a department
- Reducing defects at a specific operation
- Improving [OEE](/blog/oee-overall-equipment-effectiveness) at a bottleneck machine
...
**Morning**: Train the team on relevant lean tools — [7 wastes](/blog/7-wastes-lean-manufacturing) identification, [standard work](/blog/standard-work-manufacturing) analysis, time study methods, spaghetti diagrams.
...
- Create [5S](/blog/5s-methodology-implementation) shadow boards and organized tool storage
- Separate internal and external setup tasks ([SMED](/blog/smed-quick-changeover))
- Install visual controls — Kanban signals, andon lights, production status boards
- Build fixtures, jigs, or [poka-yoke devices](/blog/poka-yoke-error-proofing) to prevent errors
...
**Morning**: Document the new standard. Write or update [standard work](/blog/standard-work-manufacturing) instructions. Take "after" photos. Train all affected operators on the new process.
...
Assign an improvement champion (often the area supervisor) who owns the follow-up and reports progress weekly. Track Kaizen event sustainability rates as a [key lean KPI](/blog/lean-manufacturing-kpis) — target 80%+ of improvements sustained at 90 days.
