...
The **Auto Calc Hours (derive missing side from Rate)** checkbox governs the conversion. Leave it ticked and you type one side only: enter six hours and the pieces fill in from the rate, or enter the pieces and the hours derive. This is the normal way to work, because most shops genuinely count one side and estimate the other.
