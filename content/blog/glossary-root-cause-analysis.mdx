...
**Root cause analysis (RCA)** is a systematic investigation methodology used in manufacturing to identify the fundamental, underlying cause of a problem — the deepest systemic reason a [defect](/blogs/glossary-defect), failure, or undesirable event occurred. RCA goes beyond treating symptoms to find and eliminate the source of the problem, preventing recurrence.
...
RCA is a required component of [corrective action](/blogs/glossary-corrective-action) systems under [ISO 9001](/blogs/glossary-iso-9001) and other quality standards. It is also a key tool in the Analyze phase of [DMAIC](/blogs/glossary-dmaic) and is central to [Six Sigma](/blogs/glossary-six-sigma) and lean manufacturing improvement methodologies.
...
- [Corrective Action](/blogs/glossary-corrective-action) — the systematic process that uses RCA to eliminate the root cause of detected problems
- [FMEA](/blogs/glossary-fmea) — a proactive risk analysis tool that identifies potential failure modes before they occur
- [Pareto Chart](/blogs/glossary-pareto-chart) — a prioritization tool that identifies which problems to apply RCA to first
