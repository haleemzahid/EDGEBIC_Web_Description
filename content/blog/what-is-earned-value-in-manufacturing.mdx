...
Read earned value alongside its two ratios, [SPI](/blog/what-is-schedule-performance-index) and [CPI](/blog/what-is-cost-performance-index), and a single job's schedule and cost position becomes readable at a glance. The cost half of that pair rests on [actual cost](/blog/what-is-actual-cost-in-earned-value-reporting), the hours truly logged against the job by the cut-off date.
