...
A team that reads its logs by habit catches a broken sync the morning after rather than the week after, and hands support a specific file instead of a vague symptom. For the wider operational picture behind these surfaces, see [what production scheduling is](/blog/what-is-production-scheduling), and for the full administrator reference, return to the [EDGEBIC admin guide](/blog/edgebic-admin-guide).
