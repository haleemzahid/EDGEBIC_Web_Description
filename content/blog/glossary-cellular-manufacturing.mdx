...
2. **Cell design**: Arrange equipment in sequence with minimal distance between operations. Size the cell for the required takt time. Design for [one-piece flow](/blog/glossary/one-piece-flow) where possible.
...
5. **Visual controls**: Implement [visual management](/blog/glossary/visual-management) within the cell: production boards, quality displays, [standard work](/blog/glossary/standard-work) documents, and [5S](/blog/glossary/5s) organization.
...
The [lean manufacturing guide](/blog/lean-manufacturing-guide) describes cellular manufacturing as the physical manifestation of lean flow — organizing the factory around the product rather than around the process.

## Related Terms

- **[One-Piece Flow](/blog/glossary/one-piece-flow)** — The production ideal that cellular manufacturing enables by arranging operations in sequence within a compact cell.
- **[Flow Production](/blog/glossary/flow-production)** — The broader production strategy based on continuous movement that cells implement at the work-center level.
- **[Batch Production](/blog/glossary/batch-production)** — The traditional production method that cellular manufacturing replaces for suitable product families.

---

**See all lean and scheduling terms in the [Manufacturing Glossary](/blog/manufacturing-glossary).**

{/* glossary-link-injected: glossary-manufacturing-cell */}
> **Related glossary term:** [What is a Manufacturing Cell? (Glossary)](/blog/glossary/manufacturing-cell)
