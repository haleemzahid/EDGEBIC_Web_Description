...
- [Demand Planning](/blog/glossary-demand-planning) — The forecasting process that attempts to predict demand despite variability
- [Safety Stock](/blog/glossary-safety-stock) — Inventory buffer sized directly based on demand variability
- [Bullwhip Effect](/blog/glossary-bullwhip-effect) — The supply chain phenomenon that amplifies demand variability upstream
