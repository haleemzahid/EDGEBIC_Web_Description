...
- [Inbound Logistics](/blog/glossary/inbound-logistics) — The upstream counterpart handling raw material flow from suppliers to production
- [Supply Chain Management](/blog/glossary/supply-chain-management) — The broader discipline that coordinates both inbound and outbound logistics
- [Third-Party Logistics](/blog/glossary/third-party-logistics) — External providers that can manage outbound logistics operations on behalf of the manufacturer
