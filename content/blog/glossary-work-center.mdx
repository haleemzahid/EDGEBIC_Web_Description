...
- [Routing](/blogs/glossary-routing) — The sequence of operations that references work centers for each manufacturing step
- [Loading](/blogs/glossary-loading) — The process of assigning work hours to work centers to determine utilization
- [Capacity Planning](/blogs/glossary-capacity-planning) — The process of matching workload to work center capacity
