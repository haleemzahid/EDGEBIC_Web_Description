...
- **8.1 Operational planning**: Plan production processes including [scheduling](/blog/what-is-production-scheduling)
- **8.4 External providers**: Manage supplier quality, [incoming inspection](/blog/incoming-quality-inspection)
...
Monitor, measure, analyze, and evaluate QMS performance. This includes customer satisfaction, internal audits, [SPC data](/blog/statistical-process-control-spc), [KPI tracking](/blog/manufacturing-kpis-guide), and management review.

### Clause 10: Improvement
Drive continual improvement through corrective actions, [root cause analysis](/blog/root-cause-analysis), and [CAPA processes](/blog/capa-manufacturing).
...
Scheduling data — [on-time delivery rates](/blog/on-time-delivery-kpi), schedule adherence, capacity utilization — provides measurable performance data that ISO 9001 requires for monitoring organizational performance.

### Clause 10.2: Corrective Action
When quality escapes occur, [root cause analysis](/blog/root-cause-analysis) often reveals scheduling factors: rushed setups, overtime fatigue, skipped inspections due to time pressure. Scheduling improvement is frequently a legitimate corrective action for quality problems.
...
- Implement quality processes (inspection, [SPC](/blog/control-charts-manufacturing), [CAPA](/blog/capa-manufacturing))
...
- Ongoing [quality improvement](/blog/total-quality-management)
...
**Over-documenting.** ISO 9001:2015 requires far less documentation than previous versions. Procedure complexity should match process complexity. A [job shop](/blog/what-is-job-shop-scheduling) does not need aerospace-level documentation for simple processes.
...
| Better [on-time delivery](/blog/on-time-delivery-kpi) | 10-20% improvement |
| Lower [cost of quality](/blog/cost-of-quality) | 5-15% of revenue saved |
