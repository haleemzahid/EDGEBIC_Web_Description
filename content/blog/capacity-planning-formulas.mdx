...
- Ratio 0.85-0.95: Optimal for [constraint resources](/blog/resource-constraints-manufacturing)
...
See our detailed guide on [capacity utilization rates](/blog/capacity-utilization-rate) for benchmarks and optimization strategies.
...
**System Throughput Rate = Constraint Throughput Rate** (the constraint sets the pace for the entire system per the [Theory of Constraints](/blog/theory-of-constraints-scheduling))

### [Manufacturing Cycle Time](/blog/manufacturing-cycle-time)
...
This is why [finite capacity planning](/blog/what-is-finite-capacity-planning) targets 85-90% utilization at constraints rather than 100% — the queue time explosion at high utilization destroys lead times.
...
### [Rough-Cut Capacity Planning](/blog/rough-cut-capacity-planning) Demand
...
### [CRP](/blog/capacity-requirements-planning-crp) Detailed Demand
...
This is the most important financial metric in [Theory of Constraints](/blog/theory-of-constraints-scheduling) accounting. It determines which products generate the most money per hour of your most precious resource.
...
### [Capacity Buffer](/blog/capacity-buffers-safety-capacity)
...
**Ready to see these formulas in action on your data?** [Request a demo of RMDB](https://usersolutions.com/contact-us) and watch every capacity planning calculation run automatically against your real work orders, resources, and constraints.
