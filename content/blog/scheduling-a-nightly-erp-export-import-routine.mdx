...
- **A surprisingly low Created count** on a file you expected to add rows often means an export came out short. Re-export that one file rather than proceeding. When a scheduled export does not land at all, [what to do when the ERP export is late or missing](/blog/what-to-do-when-the-erp-export-is-late-or-missing) covers why yesterday's plan is still safe to work to and how to catch up cleanly.
