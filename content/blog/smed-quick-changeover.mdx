...
targetPhrase: "SMED quick changeover"
wordCount: 2000
readingTime: 9
...
Before improving anything, you must understand exactly what happens during the current changeover. This step requires going to the [Gemba](/blogs/gemba-walks-guide) and watching with fresh eyes.
...
These results were achieved through focused [Kaizen events](/blogs/kaizen-events-guide), typically within a 3-5 day event using the four SMED steps above.
...
Document the improved changeover as a [standard work](/blogs/standard-work-manufacturing) procedure:
...
- Include changeover time targets in [lean manufacturing KPIs](/blogs/lean-manufacturing-kpis)
