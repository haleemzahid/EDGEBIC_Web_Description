...
- [Job Shop](/blogs/glossary-job-shop) — A discrete manufacturing environment that handles high-variety, low-volume custom work
- [Bill of Materials](/blogs/glossary-bill-of-materials) — The structured list of components needed to build a discrete product
- [Routing](/blogs/glossary-routing) — The sequence of operations a discrete product follows through the shop
