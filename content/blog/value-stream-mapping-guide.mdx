...
Map the [7 wastes](/blogs/7-wastes-lean-manufacturing) onto the current state:
...
- **Implement Kanban between sawing and the cell**: Replace 6-day buffer with a 1-day supermarket controlled by [Kanban cards](/blogs/kanban-system-manufacturing).
...
- **Reduce changeover times**: Apply [SMED](/blogs/smed-quick-changeover) to milling (target: 45 min → 15 min) to enable smaller batches and more frequent changeovers.
...
1. **Month 1-2**: [5S](/blogs/5s-methodology-implementation) the milling and turning area. Implement daily management boards.
...
6. **Ongoing**: Track [lean KPIs](/blogs/lean-manufacturing-kpis) with [EDGEBI dashboards](/edgebi). Conduct monthly [Kaizen events](/blogs/kaizen-events-guide) on remaining waste.
