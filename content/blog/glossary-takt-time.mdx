...
- [Cycle Time](/blogs/glossary-cycle-time) — The actual time to produce one unit, compared against takt time to assess capacity
- [Throughput](/blogs/glossary-throughput) — The output rate that must meet or exceed the rate implied by takt time
- [Bottleneck](/blogs/glossary-bottleneck) — The constraint that prevents the production system from achieving takt time
