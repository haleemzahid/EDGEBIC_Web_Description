...
- [FMEA](/blog/fmea-manufacturing) and risk analysis
- Employee training on quality methods
- [SPC](/blog/statistical-process-control-spc) implementation and maintenance
...
**Examples:**
- [Incoming material inspection](/blog/incoming-quality-inspection)
- In-process inspection and testing
- Final inspection
- Gage calibration and measurement system maintenance
- SPC data collection and analysis
- Audit costs ([ISO 9001](/blog/iso-9001-manufacturers), customer audits)
- Laboratory testing
...
For a manufacturer with a mature [TQM](/blog/total-quality-management) program:
...
- **Reduced rework from overtime errors**: Balanced [scheduling](/blog/finite-capacity-planning-guide) that prevents excessive overtime reduces fatigue-driven errors.
...
| [Root cause investigation](/blog/root-cause-analysis) | $500 |
