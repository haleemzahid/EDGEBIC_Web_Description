...
**Safety stock** is buffer inventory held above the expected demand level to protect against uncertainty — demand variability, supply delays, quality rejections, and forecast errors. In [MRP](/blog/glossary/material-requirements-planning), safety stock acts as a floor: the system generates [planned orders](/blog/glossary/planned-order) to prevent inventory from dropping below the safety stock level.
...
MRP incorporates safety stock into the [net requirements](/blog/glossary/net-requirements) calculation:

**Net Requirements = [Gross Requirements](/blog/glossary/gross-requirements) - On-Hand - [Scheduled Receipts](/blog/glossary/scheduled-receipt) + Safety Stock**
...
In Week 2, projected on-hand (30) falls below safety stock (60). MRP generates a planned [purchase order](/blog/glossary/purchase-order) offset by the 3-week lead time, ensuring replenishment arrives before the shortage deepens.
...
**Varies by demand type.** [Independent demand](/blog/glossary/independent-demand) items (finished goods, spare parts) typically need safety stock because demand is uncertain. [Dependent demand](/blog/glossary/dependent-demand) items need less because demand is calculated — but supply uncertainty may still justify a buffer.

---

## Related Terms

- **[Net Requirements](/blog/glossary/net-requirements)** — The MRP calculation that incorporates safety stock as a minimum inventory floor.
- **[Independent Demand](/blog/glossary/independent-demand)** — The demand type most commonly protected by safety stock due to forecast uncertainty.
- **[Economic Order Quantity (EOQ)](/blog/glossary/economic-order-quantity)** — A lot-sizing method often used alongside safety stock to optimize total inventory cost.
