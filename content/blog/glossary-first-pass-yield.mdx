...
- [Scrap Rate](/blog/glossary-scrap-rate) — The percentage of production that cannot be reworked and must be discarded
- [Rework](/blog/glossary-rework) — The process of correcting defective units, a direct consequence of low FPY
- [Overall Equipment Effectiveness](/blog/glossary-oee) — A composite metric that includes quality rate, which is closely related to FPY
