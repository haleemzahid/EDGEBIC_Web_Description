...
The rule is simple and honest: elapsed time falls with the number of concurrent machines, total hours do not. You are trading no capacity to buy back calendar time on a big lot.
