...
This is different from [a work center that shows zero capacity](/blog/capacity-shows-zero-for-a-work-center-edgebic), where the machine exists but has no schedulable time. Here the machine is gone. It is also different from [a booking that points to a machine unit that is gone](/blog/a-booking-points-to-a-machine-unit-that-is-gone-edgebic), where the work center is still there and only one of its numbered instances was removed.
