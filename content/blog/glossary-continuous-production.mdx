...
- [Process Manufacturing](/blog/glossary/process-manufacturing) — The broader category that includes continuous production and batch processing
- [Planned Downtime](/blog/glossary/planned-downtime) — Scheduled maintenance stops that are critical to managing continuous production systems
- [Throughput](/blog/glossary/throughput) — The rate of output that continuous production is designed to maximize
