...
In EDGEBIC a department is master data that groups work centers for organization and reporting. You assign each work center to a department, and the department surfaces the combined capacity and utilization of its members so managers can read the shop one functional area, or one plant, at a time. The [department status](/blog/what-is-a-department-status-in-manufacturing) field, active, inactive, or under maintenance, communicates the state of the area; the location field lets a department stand in for a physical site.
