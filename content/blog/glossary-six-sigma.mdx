...
Six Sigma is built on two core methodologies: [DMAIC](/blog/glossary-dmaic) (Define, Measure, Analyze, Improve, Control) for improving existing processes, and DMADV (Define, Measure, Analyze, Design, Verify) for designing new processes. Both rely heavily on statistical analysis to make decisions based on data rather than intuition or opinion.

The sigma level of a process is a measure of its [capability](/blog/glossary-capability-index). Most manufacturing processes operate between 3 and 4 sigma (6,210 to 66,807 DPMO). A process at 6 sigma has reduced variation to the point where defects are nearly eliminated.

## How Six Sigma Works in Manufacturing

Six Sigma operates through a structured project-based approach. Organizations identify improvement opportunities, charter projects, assign trained leaders, execute the [DMAIC](/blog/glossary-dmaic) methodology, and verify results. The key elements include:
...
**Statistical Tools.** Six Sigma relies on a toolkit of statistical methods including [control charts](/blog/glossary-control-chart), [capability analysis](/blog/glossary-capability-index), hypothesis testing, regression analysis, design of experiments (DOE), [FMEA](/blog/glossary-fmea), and measurement system analysis (gauge R&R). These tools ensure that decisions are data-driven.
...
**Control:** An automated coolant concentration monitor maintains 8 ± 0.5% with alarms. Dressing frequency is hard-coded in the CNC program. [SPC](/blog/glossary-spc) charts monitor surface finish every 25 parts.
...
Six Sigma projects that reduce setup time, improve [first pass yield](/blog/glossary-first-pass-yield), or eliminate [unplanned downtime](/blog/glossary-unplanned-downtime) directly increase the available capacity that schedulers can allocate to production orders.

## Related Terms

- [DMAIC](/blog/glossary-dmaic) — the five-phase improvement methodology used in Six Sigma projects
- [SPC](/blog/glossary-spc) — statistical process control tools used extensively in Six Sigma analysis and control
- [Capability Index](/blog/glossary-capability-index) — the statistical measure that Six Sigma uses to quantify process performance
