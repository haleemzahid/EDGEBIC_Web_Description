...
**How to confirm:** run the anomaly report for the job. If the dependency finding is empty, causes 1 through 3 explain everything you are seeing. For the two-step version of this symptom, [two steps of one job overlapping when they should not](/blog/two-steps-of-one-job-overlap-in-the-schedule-edgebic) separates a real violation from configured lot streaming.
