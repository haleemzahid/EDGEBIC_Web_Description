...
Routings need products and work centers to exist first, so [how to import products](/blog/how-to-import-products-from-excel-in-edgebic) is the usual prerequisite. When it is one product's steps you want reproduced on another rather than a whole catalog, [how to copy a routing to another product](/blog/how-to-copy-a-routing-to-another-product-in-edgebic) covers the in-app route. Once routings are loaded, [how to import sales orders](/blog/how-to-import-sales-orders-from-excel-in-edgebic) brings in the jobs to schedule. For the full task library, see [the EDGEBIC how-to hub](/blog/edgebic-how-to-hub), and for the wider platform, [EDGEBIC](/edgebic).
