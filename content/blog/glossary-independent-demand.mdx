...
<Image
  ...
  alt="Independent demand forecast chart for manufacturing glossary"
  width="768"
  height="432"
  className="w-full rounded-lg"
/>

**Independent demand** is demand for a product that originates from external customers or the market, independent of demand for any other item in the manufacturing system. Unlike [dependent demand](/blogs/glossary-dependent-demand), which is calculated through [BOM](/blogs/glossary-bill-of-materials) explosion, independent demand must be forecasted because it is driven by factors outside the manufacturer's control.
...
The forecast feeds into the **Master Production Schedule (MPS)**, which becomes the driving input for [MRP](/blogs/glossary-material-requirements-planning). From there, MRP calculates all dependent demand through BOM explosion.
...
- **Managed with safety stock** — [safety stock](/blogs/glossary-safety-stock) buffers against forecast error
...
- **[Dependent Demand](/blogs/glossary-dependent-demand)** — Demand calculated from a parent item's schedule, the counterpart to independent demand.
- **[Safety Stock](/blogs/glossary-safety-stock)** — Buffer inventory held to protect against independent demand forecast error and supply variability.
- **[Available-to-Promise (ATP)](/blogs/glossary-available-to-promise)** — The uncommitted portion of inventory or planned production used to promise delivery of independent demand orders.
