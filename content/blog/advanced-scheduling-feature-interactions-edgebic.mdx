...
**Every scheduling feature in [EDGEBIC by User Solutions](/edgebic) behaves predictably on its own. The surprises come from combinations, and almost all of them are documented, checkable, and fixable in one field.** This is the catalog: fourteen interactions between overlap, changeovers, machine pools, parallel machines, scheduling direction, transit and operators, with the symptom, the reason, and the fix.
...
[What the anomaly checks actually look for](/blog/what-the-edgebic-anomaly-checks-actually-look-for) covers the full catalog, and [the troubleshooting guide](/blog/edgebic-troubleshooting-guide) organizes the symptom-first paths.
