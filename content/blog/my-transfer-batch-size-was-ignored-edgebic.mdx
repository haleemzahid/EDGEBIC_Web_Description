...
**Fix:** lower the transfer batch to a fraction of the smallest order that routinely runs through the step, commonly 10 to 25 percent of a typical order. Size it to your small orders, not your large ones, so the cap never turns it serial.
