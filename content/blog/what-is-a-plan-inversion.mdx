...
For the neighboring critical checks, see the [instance collision](/blog/what-is-an-instance-collision) and [over-utilization](/blog/what-is-an-over-utilization-check) definitions. For the full validation catalog and how to read the report, see [what the EDGEBIC anomaly checks actually look for](/blog/what-the-edgebic-anomaly-checks-actually-look-for) and the [schedule diagnostics overview](/blog/edgebic-schedule-diagnostics-explained).
