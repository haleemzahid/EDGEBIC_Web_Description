...
If a resource that has no real capacity of its own were allowed into this grid, it would create hours no machine backs, the failure mode described in [phantom capacity](/blog/what-is-phantom-capacity-in-scheduling). To see how the totals these cells accumulate are read against demand across the plant, read [load vs capacity in scheduling](/blog/what-is-load-vs-capacity-in-scheduling).
