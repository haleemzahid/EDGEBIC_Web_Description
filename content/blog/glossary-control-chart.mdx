...
When control chart data shows a process going out of control, the production scheduler needs to respond. Using scheduling software like [Resource Manager DB](/resource-manager-db-2/), the planner can quickly assess the impact of unplanned downtime for investigation and repair, additional rework operations that need capacity, and potential delays to downstream operations and customer deliveries.
