...
A setup matrix entry is a single honest number in the one place it is needed. For the wider vocabulary, see the [manufacturing glossary](/blog/manufacturing-glossary), and to see changeovers resolved inside a live plan, explore [EDGEBIC](/edgebic).
