...
- [Bill of Materials](/blog/glossary-bill-of-materials) — The structured document that defines the components within each subassembly
- [Assembly Line](/blog/glossary-assembly-line) — The production arrangement where subassemblies are combined into finished products
- [Assemble-to-Order](/blog/glossary-assemble-to-order) — A strategy that stocks subassemblies and assembles them upon customer order
