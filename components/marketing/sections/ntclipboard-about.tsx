...
export function NTClipboardAbout(): React.JSX.Element {
  const teamMembers = [
    ...
    },
    {
      ...
      description: 'Richard joined User Solutions as a young lad of 14 or 15 looking to learn about Graphic Design, Marketing and more. Richard and built one of the very first Manufacturing Software Websites, way back in the early 90\'s! We are so grateful he is still part of US.',
      philosophy: ''
    },
    {
      name: 'Haleem Khan',
