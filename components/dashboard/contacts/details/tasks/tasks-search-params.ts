...
// Co-located search-params for the contact Tasks tab, mirroring
// tickets-search-params.ts. The tab receives the full task list, so
...
export const searchParams = {
  ...
  sortBy: parseAsStringLiteral(Object.values(TasksSortBy)).withDefault(
