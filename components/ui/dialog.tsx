  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          // Cap to the viewport and scroll when content is taller, so long
          // modals never run off-screen with no scrollbar. All original
          // layout classes are unchanged so existing modals are unaffected.
