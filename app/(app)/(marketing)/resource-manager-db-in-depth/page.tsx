    ...
    <div className="min-h-screen">
      ...
      <section className="py-6">
        <div className="container mx-auto max-w-7xl px-4 text-center">
          <h1 className="text-3xl font-bold">Resource Manager DB: In Depth</h1>
        </div>
      </section>
            ...
            <div className="space-y-12">
              ...
              <div className="grid items-center gap-8 md:grid-cols-2">
                <div>
                  ...
                  <p className="mb-4 text-slate-600">
                    ...
                    single, simple menu (dashboard) requiring minimal
                    transactions to keep the system accurate.
                  </p>
              ...
              <div className="grid items-center gap-8 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mb-4 text-slate-600">
                    ...
                    flexible structure and data integration, enables us to offer
                    a no-risk, pre-sales, implementation walk-through to
                    demonstrate exactly how the system can benefit your
                    operations.
                  </p>
                  <p className="mb-4 text-slate-600">
                  ...
                  <p className="text-slate-600">
                    ...
                    hours or days, vs. typical custom programming taking weeks
                    or months. By driving our product development based on your
                    requests, combined with the rapid custom configuration
                    abilities of RMDB, the result is a solution that fits your
                    operation like a glove, quickly and affordably. Featuring
                    easy integration with Excel, ERP, accounting, custom or
                    other legacy systems, RMDB will provide you unsurpassed
              ...
              <div className="grid items-center gap-8 md:grid-cols-2">
                <div>
                  ...
                  <p className="mb-6 text-slate-600">
                    ...
                    utilizes your existing data resulting in rapid
                    implementation and acceptance success.
                  </p>
              ...
              <div className="grid items-center gap-8 md:grid-cols-2">
                <div>
                  ...
                  <p className="mb-4 text-slate-600">
                    ...
                    such as ERP, then refresh on demand. Starting from scratch?
                    Resource Manager-DB features a clean and simple way to
                    create master item lists and dynamically create
                    bills-of-resources.
                  </p>
                  <p className="mb-4 text-slate-600">
                    Resource Manager-DB is designed to work seamlessly with
                    Excel. <strong>IMPORTANT TAKEAWAY #1:</strong> This provides
                    great flexibility in rapid implementation options as it
                    allows you to load, edit, reload entire data sets with the
                    click of a button.
                  </p>
                  <p className="text-slate-600">
                    <strong>IMPORTANT TAKEAWAY #2:</strong> Output reports can
                    easily circulate throughout the organization in familiar
                    Excel format for editing and reimporting back into Resource
                    Manager-DB to update the system. Reports run on any version
                    of Excel anywhere — Cloud, tablet, laptop, desktop, on-site,
                    off-site and enterprise wide.
                  </p>
                </div>
                <div>
                  <Image
              ...
              <div>
                ...
                <div className="grid items-center gap-8 md:grid-cols-2">
                  ...
                  <div>
                    <p className="mb-4 text-slate-600">
                      <span className="px-1">Where do you need to go?</span>{' '}
                      Which orders need to be shipped when? Resource Manager
                      features a simple, single, screen to control your whole
                      operation.
                    </p>
                    <p className="mb-4 text-slate-600">
                      Enter (or link with outside system), the quantities and
                      due dates. Optionally add detailed customer or order
                      information. Now schedule.
                    </p>
                    <p className="text-slate-600">
                      Only Resource Manager gives you quick and easy top level
                      control for recognizing the immediate benefits of an
              ...
              <div>
                ...
                <div className="grid items-center gap-8 md:grid-cols-2">
                  <div>
                    <p className="mb-4 text-slate-600">
                      That's it! You are in the driver's seat and cruise control
                      is on. Enjoy the view. Check the production calendar for a
                      quick view of finite-capacity loading on work centers and
                      time-phased inventory levels. Bottlenecks are easy to spot
                      by the red flags. Run your favorite report to view
                      schedule data the way you like it.
                    </p>
                    <p className="text-slate-600">
                      Need to correct a schedule? Quickly adjust working
                      calendar, shift available resources, and click to
                      reschedule. For effortless cruise control of your
                      business, simply make the top level changes and regenerate
                      the master schedule with a click of the mouse. Change
                      delivery due dates, split up quantities, combine forward
                      and reverse scheduling; all the options for a quick
                      adjustment are under your immediate control.
                    </p>
                  </div>
                  <div>
                    <Image
              ...
              <div>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      A great top-level view of all activity with details only a
                      click away. Instantly check the due dates of all jobs in
                      schedule, drill down to find bottlenecks, adjust capacity
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      The report will tell you what you need to buy or make, how
                      much, and when – all consolidated on a single sheet. An
                      instant, top level MRP Report for all products and
                      workcenter loading. View over any time horizon – by day,
                      week, or month.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      ...
                      WorkCenter Loading, listing each job with start/completion
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      View and print the schedule in familiar "wall calendar"
                      format.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Instant, real-time views of all critical workcenter
                      activity by: daily loading, backlog, % utilization, hours
                      available and bottlenecks. Allows for quick overtime
                      scheduling and other detailed adjustments for any
                      workcenter on any day. Also features a daily workcenter
                      "to-do" list.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Intuitive reports for visual bill-of-resource
                      verification, process flow and schedule feedback.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      ...
                      reconciles inventory and capacity for a job and lists
                      sequence of operations and products to fulfill order on
                      time. Includes space for check off and actual feedback as
                      well as job costing and variance reporting.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Resource Manager-DB excels with its integrated purchasing
                      and receiving module. Designed to meet the tough
                      requirements for Lean Manufacturing. Generate purchase
                      orders via Kanban or standard requirements with one click.
                      Track received quantities, open/closed status, and adjust
                      inventory automatically. Auto-email RFQs and POs to
                      vendors.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  ...
                  special needs, including: automatic data integration with
                  other systems, customized reports, on site training and
                  configuration and much more. In addition, User Solutions has
                  partnered with a number of complementary product and service
                  companies to provide complete solutions focused on unique
                  needs.
                </p>
              </div>
            </div>
            ...
            <div className="grid items-start gap-8 lg:grid-cols-2">
              <div>
                ...
                <div className="space-y-4 text-base leading-relaxed text-slate-600">
                  <p>
                    Get started with Resource Manager-DB quickly and easily. Our
                    Quick Start guide provides step-by-step instructions to help
                    you set up and configure RMDB for your specific needs.
                  </p>
                  <p>
                    Download the comprehensive Quick Start PDF guide to begin
                    your journey with RMDB.
                  </p>
                  <a
          ...
          {activeTab === 'live-demo' && (
            <div className="grid items-start gap-8 lg:grid-cols-2">
              <div>
                ...
                <div className="space-y-4 text-base leading-relaxed text-slate-600">
                  <p>
                    See Resource Manager-DB in action! Schedule a live demo with
                    our team to experience how RMDB can transform your
                    production planning and scheduling processes.
                  </p>
                  <p>
                    We can even use your data in its current form to show you
                    exactly how RMDB will work for your specific operations –
                    RISK FREE!
                  </p>
                  <Link
                    href="/contact-us"
