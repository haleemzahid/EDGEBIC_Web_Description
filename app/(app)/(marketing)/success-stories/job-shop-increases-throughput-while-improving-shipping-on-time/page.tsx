...
export const metadata = createArticleMetadata({
  ...
  path: '/success-stories/job-shop-increases-throughput-while-improving-shipping-on-time',
...
export default function JobShopThroughputPage() {
  return (
    <div className="min-h-screen">
      ...
      <RelatedProducts storySlug="/success-stories/job-shop-increases-throughput-while-improving-shipping-on-time" />
    </div>
  );
}
