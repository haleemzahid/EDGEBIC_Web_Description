...
export const metadata = createArticleMetadata({
  ...
  path: '/success-stories/repair-shops-triple-on-time-shipping-percentage-from-30-to-90',
...
export default function RepairShopsTriplePage() {
  return (
    <div className="min-h-screen">
      ...
      <RelatedProducts storySlug="/success-stories/repair-shops-triple-on-time-shipping-percentage-from-30-to-90" />
    </div>
  );
}
