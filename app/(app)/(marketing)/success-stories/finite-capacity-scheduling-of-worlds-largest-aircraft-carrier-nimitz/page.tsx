...
export const metadata = createArticleMetadata({
  ...
  path: '/success-stories/finite-capacity-scheduling-of-worlds-largest-aircraft-carrier-nimitz',
...
export default function AircraftCarrierNimitzPage() {
  return (
    <div className="min-h-screen">
      ...
      <RelatedProducts storySlug="/success-stories/finite-capacity-scheduling-of-worlds-largest-aircraft-carrier-nimitz" />
    </div>
  );
}
