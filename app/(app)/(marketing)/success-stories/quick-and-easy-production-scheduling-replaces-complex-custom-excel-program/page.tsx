...
export const metadata = createArticleMetadata({
  ...
  path: '/success-stories/quick-and-easy-production-scheduling-replaces-complex-custom-excel-program',
...
export default function QuickSchedulingExcelReplacementPage() {
  return (
    <div className="min-h-screen">
      ...
      <RelatedProducts storySlug="/success-stories/quick-and-easy-production-scheduling-replaces-complex-custom-excel-program" />
    </div>
  );
}
