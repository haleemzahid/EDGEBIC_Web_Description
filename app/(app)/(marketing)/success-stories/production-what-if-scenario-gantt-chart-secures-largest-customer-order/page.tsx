...
export const metadata = createArticleMetadata({
  ...
  path: '/success-stories/production-what-if-scenario-gantt-chart-secures-largest-customer-order',
...
export default function ProductionWhatIfScenarioPage() {
  return (
    <div className="min-h-screen">
      ...
      <RelatedProducts storySlug="/success-stories/production-what-if-scenario-gantt-chart-secures-largest-customer-order" />
    </div>
  );
}
