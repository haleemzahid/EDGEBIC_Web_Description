...
export const metadata = createArticleMetadata({
  ...
  path: '/success-stories/scheduling-labor-out-several-months-increases-customer-satisfaction',
...
export default function SchedulingLaborPage() {
  return (
    <div className="min-h-screen">
      ...
      <RelatedProducts storySlug="/success-stories/scheduling-labor-out-several-months-increases-customer-satisfaction" />
    </div>
  );
}
