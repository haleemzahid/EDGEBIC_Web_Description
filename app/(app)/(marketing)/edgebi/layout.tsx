...
export const metadata = createProductMetadata({
  ...
  description: 'EDGEBI is the advanced graphical extension for Resource Manager DB (RMDB), adding interactive Gantt charts, visual drag-and-drop scheduling, manufacturing business intelligence, real-time dashboards, machine monitoring, and shop floor analytics for production planning.',
  path: '/edgebi',
