export enum Routes {
  ...
  ResourceManagerForExcel = '/resource-manager-for-excel-2',
  ResourceManagerDb = '/resource-manager-db-2',
  CompareProducts = '/compare-products',
  Edgebi = '/edgebi',
  Edgebic = '/edgebic',
  RmdbToEdgebic = '/rmdb-to-edgebic',
  EdgebicErpIntegration = '/edgebic-erp-integration',
